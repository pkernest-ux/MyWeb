function cv(s){return s&&s.__esModule&&Object.prototype.hasOwnProperty.call(s,"default")?s.default:s}var Gu={exports:{}},Ja={},ju={exports:{}},qt={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var hm;function dv(){if(hm)return Ja;hm=1;var s=Tf(),e=Symbol.for("react.element"),t=Symbol.for("react.fragment"),r=Object.prototype.hasOwnProperty,o=s.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,l={key:!0,ref:!0,__self:!0,__source:!0};function u(f,h,p){var v,S={},x=null,M=null;p!==void 0&&(x=""+p),h.key!==void 0&&(x=""+h.key),h.ref!==void 0&&(M=h.ref);for(v in h)r.call(h,v)&&!l.hasOwnProperty(v)&&(S[v]=h[v]);if(f&&f.defaultProps)for(v in h=f.defaultProps,h)S[v]===void 0&&(S[v]=h[v]);return{$$typeof:e,type:f,key:x,ref:M,props:S,_owner:o.current}}return Ja.Fragment=t,Ja.jsx=u,Ja.jsxs=u,Ja}var pm;function fv(){return pm||(pm=1,Gu.exports=dv()),Gu.exports}var g=fv(),Pe=Tf();const Af=cv(Pe);var _l={},Wu={exports:{}},si={},Xu={exports:{}},Yu={};/**
 * @license React
...
#endif`,Ry="gl_FragColor = linearToOutputTexel( gl_FragColor );",Ny=`vec4 LinearTransferOETF( in vec4 value ) {
	return value;
}
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:br,depthTest:!1,depthWrite:!1})}function G1(s,e,t){const r=new Float32Array(Es),o=new ie(0,1,0);return new or({name:"SphericalGaussianBlur",defines:{n:Es,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${s}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:o}},vertexShader:hc(),fragmentShader:`
	...
	`}class gg extends rr{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const r={width:e,height:e,depth:1},o=[r,r,r,r,r,r];this.texture=new og(o),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const r={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},o=new vo(5,5,5),l=new or({name:"CubemapFromEquirect",uniforms:ya(r.uniforms),vertexShader:r.vertexShader,fragmentShader:r.fragmentShader,side:oi,blending:br});l.uniforms.tEquirect.value=t;const u=new Qn(o,l),f=t.minFilter;return t.minFilter===ws&&(t.minFilter=jn),new q_(1,10,this).update(e,u),t.minFilter=f,u.geometry.dispose(),u.material.dispose(),this}clear(e,t=!0,r=!0,o=!0){const l=e.getRenderTarget();for(let u=0;u<6;u++)e.setRenderTarget(this,u),e.clear(t,r,o);e.setRenderTarget(l)}}function j1(s){let e=new WeakMap,t=new WeakMap,r=null;function o(x,M=!1){return x==null?null:M?u(x):l(x)}function l(x){if(x&&x.isTexture){const M=x.mapping;if(M===$u||M===qu)if(e.has(x)){const C=e.get(x).texture;return f(C,x.mapping)}else{const C=x.image;if(C&&C.height>0){const D=new gg(C.height);return D.fromEquirectangularTexture(s,x),e.set(x,D),x.addEventListener("dispose",p),f(D.texture,x.mapping)}else return null}}return x}function u(x){if(x&&x.isTexture){const M=x.mapping,C=M===$u||M===qu,D=M===As||M===va;if(C||D){let y=t.get(x);const _=y!==void 0?y.texture.pmremVersion:0;if(x.isRenderTargetTexture&&x.pmremVersion!==_)return r===null&&(r=new e0(s)),y=C?r.fromEquirectangular(x,y):r.fromCubemap(x,y),y.texture.pmremVersion=x.pmremVersion,t.set(x,y),y.texture;if(y!==void 0)return y.texture;{const L=x.image;return C&&L&&L.height>0||D&&L&&h(L)?(r===null&&(r=new e0(s)),y=C?r.fromEquirectangular(x):r.fromCubemap(x),y.texture.pmremVersion=x.pmremVersion,t.set(x,y),x.addEventListener("dispose",v),y.texture):null}}}return x}function f(x,M){return M===$u?x.mapping=As:M===qu&&(x.mapping=va),x}function h(x){let M=0;const C=6;for(let D=0;D<C;D++)x[D]!==void 0&&M++;return M===C}function p(x){const M=x.target;M.removeEventListener("dispose",p);const C=e.get(M);C!==void 0&&(e.delete(M),C.dispose())}function v(x){const M=x.target;M.removeEventListener("dispose",v);const C=t.get(M);C!==void 0&&(t.delete(M),C.dispose())}function S(){e=new WeakMap,t=new WeakMap,r!==null&&(r.dispose(),r=null)}return{get:o,dispose:S}}function W1(s){const e={};function t(r){if(e[r]!==void 0)return e[r];const o=s.getExtension(r);return e[r]=o,o}return{has:function(r){return t(r)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(r){const o=t(r);return o===null&&yf("WebGLRenderer: "+r+" extension not supported."),o}}}function X1(s,e,t,r){const o={},l=new WeakMap;function u(S){const x=S.target;x.index!==null&&e.remove(x.index);for(const C in x.attributes)e.remove(x.attributes[C]);x.removeEventListener("dispose",u),delete o[x.id];const M=l.get(x);M&&(e.remove(M),l.delete(x)),r.releaseStatesOfGeometry(x),x.isInstancedBufferGeometry===!0&&delete x._maxInstanceCount,t.memory.geometries--}function f(S,x){return o[x.id]===!0||(x.addEventListener("dispose",u),o[x.id]=!0,t.memory.geometries++),x}function h(S){const x=S.attributes;for(const M in x)e.update(x[M],s.ARRAY_BUFFER)}function p(S){const x=[],M=S.index,C=S.attributes.position;let D=0;if(C===void 0)return;if(M!==null){const L=M.array;D=M.version;for(let R=0,P=L.length;R<P;R+=3){const V=L[R+0],I=L[R+1],O=L[R+2];x.push(V,I,I,O,O,V)}}else{const L=C.array;D=C.version;for(let R=0,P=L.length/3-1;R<P;R+=3){const V=R+0,I=R+1,O=R+2;x.push(V,I,I,O,O,V)}}const y=new(C.count>=65535?sg:rg)(x,1);y.version=D;const _=l.get(S);_&&e.remove(_),l.set(S,y)}function v(S){const x=l.get(S);if(x){const M=S.index;M!==null&&x.version<M.version&&p(S)}else p(S);return l.get(S)}return{get:f,update:h,getWireframeAttribute:v}}function Y1(s,e,t){let r;function o(S){r=S}let l,u;function f(S){l=S.type,u=S.bytesPerElement}function h(S,x){s.drawElements(r,x,l,S*u),t.update(x,r,1)}function p(S,x,M){M!==0&&(s.drawElementsInstanced(r,x,l,S*u,M),t.update(x,r,M))}function v(S,x,M){if(M===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(r,x,0,l,S,0,M);let D=0;for(let y=0;y<M;y++)D+=x[y];t.update(D,r,1)}this.setMode=o,this.setIndex=f,this.render=h,this.renderInstances=p,this.renderMultiDraw=v}function $1(s){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function r(l,u,f){switch(t.calls++,u){case s.TRIANGLES:t.triangles+=f*(l/3);break;case s.LINES:t.lines+=f*(l/2);break;case s.LINE_STRIP:t.lines+=f*(l-1);break;case s.LINE_LOOP:t.lines+=f*l;break;case s.POINTS:t.points+=f*l;break;default:en("WebGLInfo: Unknown draw mode:",u);break}}function o(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:o,update:r}}function q1(s,e,t){const r=new WeakMap,o=new vn;function l(u,f,h){const p=u.morphTargetInfluences,v=f.morphAttributes.position||f.morphAttributes.normal||f.morphAttributes.color,S=v!==void 0?v.length:0;let x=r.get(f);if(x===void 0||x.count!==S){let Y=function(){T.dispose(),r.delete(f),f.removeEventListener("dispose",Y)};var M=Y;x!==void 0&&x.texture.dispose();const C=f.morphAttributes.position!==void 0,D=f.morphAttributes.normal!==void 0,y=f.morphAttributes.color!==void 0,_=f.morphAttributes.position||[],L=f.morphAttributes.normal||[],R=f.morphAttributes.color||[];let P=0;C===!0&&(P=1),D===!0&&(P=2),y===!0&&(P=3);let V=f.attributes.position.count*P,I=1;V>e.maxTextureSize&&(I=Math.ceil(V/e.maxTextureSize),V=e.maxTextureSize);const O=new Float32Array(V*I*4*S),T=new tg(O,V,I,S);T.type=tr,T.needsUpdate=!0;const N=P*4;for(let H=0;H<S;H++){const Q=_[H],re=L[H],pe=R[H],X=V*I*4*H;for(let oe=0;oe<Q.count;oe++){const J=oe*N;C===!0&&(o.fromBufferAttribute(Q,oe),O[X+J+0]=o.x,O[X+J+1]=o.y,O[X+J+2]=o.z,O[X+J+3]=0),D===!0&&(o.fromBufferAttribute(re,oe),O[X+J+4]=o.x,O[X+J+5]=o.y,O[X+J+6]=o.z,O[X+J+7]=0),y===!0&&(o.fromBufferAttribute(pe,oe),O[X+J+8]=o.x,O[X+J+9]=o.y,O[X+J+10]=o.z,O[X+J+11]=pe.itemSize===4?o.w:1)}}x={count:S,texture:T,size:new Lt(V,I)},r.set(f,x),f.addEventListener("dispose",Y)}if(u.isInstancedMesh===!0&&u.morphTexture!==null)h.getUniforms().setValue(s,"morphTexture",u.morphTexture,t);else{let C=0;for(let y=0;y<p.length;y++)C+=p[y];const D=f.morphTargetsRelative?1:1-C;h.getUniforms().setValue(s,"morphTargetBaseInfluence",D),h.getUniforms().setValue(s,"morphTargetInfluences",p)}h.getUniforms().setValue(s,"morphTargetsTexture",x.texture,t),h.getUniforms().setValue(s,"morphTargetsTextureSize",x.size)}return{update:l}}function K1(s,e,t,r,o){let l=new WeakMap;function u(p){const v=o.render.frame,S=p.geometry,x=e.get(p,S);if(l.get(x)!==v&&(e.update(x),l.set(x,v)),p.isInstancedMesh&&(p.hasEventListener("dispose",h)===!1&&p.addEventListener("dispose",h),l.get(p)!==v&&(t.update(p.instanceMatrix,s.ARRAY_BUFFER),p.instanceColor!==null&&t.update(p.instanceColor,s.ARRAY_BUFFER),l.set(p,v))),p.isSkinnedMesh){const M=p.skeleton;l.get(M)!==v&&(M.update(),l.set(M,v))}return x}function f(){l=new WeakMap}function h(p){const v=p.target;v.removeEventListener("dispose",h),r.releaseStatesOfObject(v),t.remove(v.instanceMatrix),v.instanceColor!==null&&t.remove(v.instanceColor)}return{update:u,dispose:f}}const Z1={[B0]:"LINEAR_TONE_MAPPING",[z0]:"REINHARD_TONE_MAPPING",[V0]:"CINEON_TONE_MAPPING",[H0]:"ACES_FILMIC_TONE_MAPPING",[j0]:"AGX_TONE_MAPPING",[W0]:"NEUTRAL_TONE_MAPPING",[G0]:"CUSTOM_TONE_MAPPING"};function J1(s,e,t,r,o){const l=new rr(e,t,{type:s,depthBuffer:r,stencilBuffer:o,depthTexture:r?new _a(e,t):void 0}),u=new rr(e,t,{type:Ar,depthBuffer:!1,stencilBuffer:!1}),f=new vi;f.setAttribute("position",new _n([-1,3,0,-1,-1,0,3,-1,0],3)),f.setAttribute("uv",new _n([0,2,0,0,2,0],2));const h=new X_({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),p=new Qn(f,h),v=new hg(-1,1,1,-1,0,1);let S=null,x=null,M=!1,C,D=null,y=[],_=!1;this.setSize=function(L,R){l.setSize(L,R),u.setSize(L,R);for(let P=0;P<y.length;P++){const V=y[P];V.setSize&&V.setSize(L,R)}},this.setEffects=function(L){y=L,_=y.length>0&&y[0].isRenderPass===!0;const R=l.width,P=l.height;for(let V=0;V<y.length;V++){const I=y[V];I.setSize&&I.setSize(R,P)}},this.begin=function(L,R){if(M||L.toneMapping===ir&&y.length===0)return!1;if(D=R,R!==null){const P=R.width,V=R.height;(l.width!==P||l.height!==V)&&this.setSize(P,V)}return _===!1&&L.setRenderTarget(l),C=L.toneMapping,L.toneMapping=ir,!0},this.hasRenderPass=function(){return _},this.end=function(L,R){L.toneMapping=C,M=!0;let P=l,V=u;for(let I=0;I<y.length;I++){const O=y[I];if(O.enabled!==!1&&(O.render(L,V,P,R),O.needsSwap!==!1)){const T=P;P=V,V=T}}if(S!==L.outputColorSpace||x!==L.toneMapping){S=L.outputColorSpace,x=L.toneMapping,h.defines={},Jt.getTransfer(S)===rn&&(h.defines.SRGB_TRANSFER="");const I=Z1[x];I&&(h.defines[I]=""),h.needsUpdate=!0}h.uniforms.tDiffuse.value=P.texture,L.setRenderTarget(D),L.render(p,v),D=null,M=!1},this.isCompositing=function(){return M},this.dispose=function(){l.depthTexture&&l.depthTexture.dispose(),l.dispose(),u.dispose(),f.dispose(),h.dispose()}}const xg=new Jn,Mf=new _a(1,1),vg=new tg,_g=new o_,yg=new og,r0=[],s0=[],a0=new Float32Array(16),o0=new Float32Array(9),l0=new Float32Array(4);function Ma(s,e,t){const r=s[0];if(r<=0||r>0)return s;const o=e*t;let l=r0[o];if(l===void 0&&(l=new Float32Array(o),r0[o]=l),e!==0){r.toArray(l,0);for(let u=1,f=0;u!==e;++u)f+=t,s[u].toArray(l,f)}return l}function Tn(s,e){if(s.length!==e.length)return!1;for(let t=0,r=s.length;t<r;t++)if(s[t]!==e[t])return!1;return!0}function An(s,e){for(let t=0,r=e.length;t<r;t++)s[t]=e[t]}function pc(s,e){let t=s0[e];t===void 0&&(t=new Int32Array(e),s0[e]=t);for(let r=0;r!==e;++r)t[r]=s.allocateTextureUnit();return t}function Q1(s,e){const t=this.cache;t[0]!==e&&(s.uniform1f(this.addr,e),t[0]=e)}function eM(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Tn(t,e))return;s.uniform2fv(this.addr,e),An(t,e)}}function tM(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(s.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(Tn(t,e))return;s.uniform3fv(this.addr,e),An(t,e)}}function nM(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Tn(t,e))return;s.uniform4fv(this.addr,e),An(t,e)}}function iM(s,e){const t=this.cache,r=e.elements;if(r===void 0){if(Tn(t,e))return;s.uniformMatrix2fv(this.addr,!1,e),An(t,e)}else{if(Tn(t,r))return;l0.set(r),s.uniformMatrix2fv(this.addr,!1,l0),An(t,r)}}function rM(s,e){const t=this.cache,r=e.elements;if(r===void 0){if(Tn(t,e))return;s.uniformMatrix3fv(this.addr,!1,e),An(t,e)}else{if(Tn(t,r))return;o0.set(r),s.uniformMatrix3fv(this.addr,!1,o0),An(t,r)}}function sM(s,e){const t=this.cache,r=e.elements;if(r===void 0){if(Tn(t,e))return;s.uniformMatrix4fv(this.addr,!1,e),An(t,e)}else{if(Tn(t,r))return;a0.set(r),s.uniformMatrix4fv(this.addr,!1,a0),An(t,r)}}function aM(s,e){const t=this.cache;t[0]!==e&&(s.uniform1i(this.addr,e),t[0]=e)}function oM(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Tn(t,e))return;s.uniform2iv(this.addr,e),An(t,e)}}function lM(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Tn(t,e))return;s.uniform3iv(this.addr,e),An(t,e)}}function cM(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Tn(t,e))return;s.uniform4iv(this.addr,e),An(t,e)}}function uM(s,e){const t=this.cache;t[0]!==e&&(s.uniform1ui(this.addr,e),t[0]=e)}function dM(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Tn(t,e))return;s.uniform2uiv(this.addr,e),An(t,e)}}function fM(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Tn(t,e))return;s.uniform3uiv(this.addr,e),An(t,e)}}function hM(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Tn(t,e))return;s.uniform4uiv(this.addr,e),An(t,e)}}function pM(s,e,t){const r=this.cache,o=t.allocateTextureUnit();r[0]!==o&&(s.uniform1i(this.addr,o),r[0]=o);let l;this.type===s.SAMPLER_2D_SHADOW?(Mf.compareFunction=t.isReversedDepthBuffer()?Ff:Uf,l=Mf):l=xg,t.setTexture2D(e||l,o)}function mM(s,e,t){const r=this.cache,o=t.allocateTextureUnit();r[0]!==o&&(s.uniform1i(this.addr,o),r[0]=o),t.setTexture3D(e||_g,o)}function gM(s,e,t){const r=this.cache,o=t.allocateTextureUnit();r[0]!==o&&(s.uniform1i(this.addr,o),r[0]=o),t.setTextureCube(e||yg,o)}function xM(s,e,t){const r=this.cache,o=t.allocateTextureUnit();r[0]!==o&&(s.uniform1i(this.addr,o),r[0]=o),t.setTexture2DArray(e||vg,o)}function vM(s){switch(s){case 5126:return Q1;case 35664:return eM;case 35665:return tM;case 35666:return nM;case 35674:return iM;case 35675:return rM;case 35676:return sM;case 5124:case 35670:return aM;case 35667:case 35671:return oM;case 35668:case 35672:return lM;case 35669:case 35673:return cM;case 5125:return uM;case 36294:return dM;case 36295:return fM;case 36296:return hM;case 35678:case 36198:case 36298:case 36306:case 35682:return pM;case 35679:case 36299:case 36307:return mM;case 35680:case 36300:case 36308:case 36293:return gM;case 36289:case 36303:case 36311:case 36292:return xM}}function _M(s,e){s.uniform1fv(this.addr,e)}function yM(s,e){const t=Ma(e,this.size,2);s.uniform2fv(this.addr,t)}function SM(s,e){const t=Ma(e,this.size,3);s.uniform3fv(this.addr,t)}function MM(s,e){const t=Ma(e,this.size,4);s.uniform4fv(this.addr,t)}function EM(s,e){const t=Ma(e,this.size,4);s.uniformMatrix2fv(this.addr,!1,t)}function wM(s,e){const t=Ma(e,this.size,9);s.uniformMatrix3fv(this.addr,!1,t)}function bM(s,e){const t=Ma(e,this.size,16);s.uniformMatrix4fv(this.addr,!1,t)}function TM(s,e){s.uniform1iv(this.addr,e)}function AM(s,e){s.uniform2iv(this.addr,e)}function CM(s,e){s.uniform3iv(this.addr,e)}function RM(s,e){s.uniform4iv(this.addr,e)}function NM(s,e){s.uniform1uiv(this.addr,e)}function PM(s,e){s.uniform2uiv(this.addr,e)}function IM(s,e){s.uniform3uiv(this.addr,e)}function DM(s,e){s.uniform4uiv(this.addr,e)}function LM(s,e,t){const r=this.cache,o=e.length,l=pc(t,o);Tn(r,l)||(s.uniform1iv(this.addr,l),An(r,l));let u;this.type===s.SAMPLER_2D_SHADOW?u=Mf:u=xg;for(let f=0;f!==o;++f)t.setTexture2D(e[f]||u,l[f])}function UM(s,e,t){const r=this.cache,o=e.length,l=pc(t,o);Tn(r,l)||(s.uniform1iv(this.addr,l),An(r,l));for(let u=0;u!==o;++u)t.setTexture3D(e[u]||_g,l[u])}function FM(s,e,t){const r=this.cache,o=e.length,l=pc(t,o);Tn(r,l)||(s.uniform1iv(this.addr,l),An(r,l));for(let u=0;u!==o;++u)t.setTextureCube(e[u]||yg,l[u])}function OM(s,e,t){const r=this.cache,o=e.length,l=pc(t,o);Tn(r,l)||(s.uniform1iv(this.addr,l),An(r,l));for(let u=0;u!==o;++u)t.setTexture2DArray(e[u]||vg,l[u])}function kM(s){switch(s){case 5126:return _M;case 35664:return yM;case 35665:return SM;case 35666:return MM;case 35674:return EM;case 35675:return wM;case 35676:return bM;case 5124:case 35670:return TM;case 35667:case 35671:return AM;case 35668:case 35672:return CM;case 35669:case 35673:return RM;case 5125:return NM;case 36294:return PM;case 36295:return IM;case 36296:return DM;case 35678:case 36198:case 36298:case 36306:case 35682:return LM;case 35679:case 36299:case 36307:return UM;case 35680:case 36300:case 36308:case 36293:return FM;case 36289:case 36303:case 36311:case 36292:return OM}}class BM{constructor(e,t,r){this.id=e,this.addr=r,this.cache=[],this.type=t.type,this.setValue=vM(t.type)}}class zM{constructor(e,t,r){this.id=e,this.addr=r,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=kM(t.type)}}class VM{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,r){const o=this.seq;for(let l=0,u=o.length;l!==u;++l){const f=o[l];f.setValue(e,t[f.id],r)}}}const Cd=/(\w+)(\])?(\[|\.)?/g;function c0(s,e){s.seq.push(e),s.map[e.id]=e}function HM(s,e,t){const r=s.name,o=r.length;for(Cd.lastIndex=0;;){const l=Cd.exec(r),u=Cd.lastIndex;let f=l[1];const h=l[2]==="]",p=l[3];if(h&&(f=f|0),p===void 0||p==="["&&u+2===o){c0(t,p===void 0?new BM(f,s,e):new zM(f,s,e));break}else{let S=t.map[f];S===void 0&&(S=new VM(f),c0(t,S)),t=S}}}class Zl{constructor(e,t){this.seq=[],this.map={};const r=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let u=0;u<r;++u){const f=e.getActiveUniform(t,u),h=e.getUniformLocation(t,f.name);HM(f,h,this)}const o=[],l=[];for(const u of this.seq)u.type===e.SAMPLER_2D_SHADOW||u.type===e.SAMPLER_CUBE_SHADOW||u.type===e.SAMPLER_2D_ARRAY_SHADOW?o.push(u):l.push(u);o.length>0&&(this.seq=o.concat(l))}setValue(e,t,r,o){const l=this.map[t];l!==void 0&&l.setValue(e,r,o)}setOptional(e,t,r){const o=t[r];o!==void 0&&this.setValue(e,r,o)}static upload(e,t,r,o){for(let l=0,u=t.length;l!==u;++l){const f=t[l],h=r[f.id];h.needsUpdate!==!1&&f.setValue(e,h.value,o)}}static seqWithValue(e,t){const r=[];for(let o=0,l=e.length;o!==l;++o){const u=e[o];u.id in t&&r.push(u)}return r}}function u0(s,e,t){const r=s.createShader(e);return s.shaderSource(r,t),s.compileShader(r),r}const GM=37297;let jM=0;function WM(s,e){const t=s.split(`
`),r=[],o=Math.max(e-6,0),l=Math.min(e+6,t.length);for(let u=o;u<l;u++){const f=u+1;r.push(`${f===e?">":" "} ${f}: ${t[u]}`)}return r.join(`
`)}const d0=new Vt;function XM(s){Jt._getMatrix(d0,Jt.workingColorSpace,s);const e=`mat3( ${d0.elements.map(t=>t.toFixed(4))} )`;switch(Jt.getTransfer(s)){case nc:return[e,"LinearTransferOETF"];case rn:return[e,"sRGBTransferOETF"];default:return Dt("WebGLProgram: Unsupported color space: ",s),[e,"LinearTransferOETF"]}}function f0(s,e,t){const r=s.getShaderParameter(e,s.COMPILE_STATUS),l=(s.getShaderInfoLog(e)||"").trim();if(r&&l==="")return"";const u=/ERROR: 0:(\d+)/.exec(l);if(u){const f=parseInt(u[1]);return t.toUpperCase()+`

`+l+`

`+WM(s.getShaderSource(e),f)}else return l}function YM(s,e){const t=XM(e);return[`vec4 ${s}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}const $M={[B0]:"Linear",[z0]:"Reinhard",[V0]:"Cineon",[H0]:"ACESFilmic",[j0]:"AgX",[W0]:"Neutral",[G0]:"Custom"};function qM(s,e){const t=$M[e];return t===void 0?(Dt("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+s+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+s+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Vl=new ie;function KM(){Jt.getLuminanceCoefficients(Vl);const s=Vl.x.toFixed(4),e=Vl.y.toFixed(4),t=Vl.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${s}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)}function QM(s,e){const t={},r=s.getProgramParameter(e,s.ACTIVE_ATTRIBUTES);for(let o=0;o<r;o++){const l=s.getActiveAttrib(e,o),u=l.name;let f=1;l.type===s.FLOAT_MAT2&&(f=2),l.type===s.FLOAT_MAT3&&(f=3),l.type===s.FLOAT_MAT4&&(f=4),t[u]={type:l.type,location:s.getAttribLocation(e,u),locationSize:f}}return t}function oo(s){return s!==""}function h0(s,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return s.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function p0(s,e){return s.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const eE=/^[ \t]*#include +<([\w\d./]+)>/gm;function Ef(s){return s.replace(eE,nE)}const tE=new Map;function nE(s,e){let t=jt[e];if(t===void 0){const r=tE.get(e);if(r!==void 0)t=jt[r],Dt('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,r);else throw new Error("Can not resolve #include <"+e+">")}return Ef(t)}const iE=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function m0(s){return s.replace(iE,rE)}function rE(s,e,t,r){let o="";for(let l=parseInt(e);l<parseInt(t);l++)o+=r.replace(/\[\s*i\s*\]/g,"[ "+l+" ]").replace(/UNROLLED_LOOP_INDEX/g,l);return o}function g0(s){let e=`precision ${s.precision} float;
...
#define LOW_PRECISION`),e}const sE={[Xl]:"SHADOWMAP_TYPE_PCF",[ao]:"SHADOWMAP_TYPE_VSM"};function aE(s){return sE[s.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const oE={[As]:"ENVMAP_TYPE_CUBE",[va]:"ENVMAP_TYPE_CUBE",[uc]:"ENVMAP_TYPE_CUBE_UV"};function lE(s){return s.envMap===!1?"ENVMAP_TYPE_CUBE":oE[s.envMapMode]||"ENVMAP_TYPE_CUBE"}const cE={[va]:"ENVMAP_MODE_REFRACTION"};function uE(s){return s.envMap===!1?"ENVMAP_MODE_REFLECTION":cE[s.envMapMode]||"ENVMAP_MODE_REFLECTION"}const dE={[k0]:"ENVMAP_BLENDING_MULTIPLY",[zv]:"ENVMAP_BLENDING_MIX",[Vv]:"ENVMAP_BLENDING_ADD"};function fE(s){return s.envMap===!1?"ENVMAP_BLENDING_NONE":dE[s.combine]||"ENVMAP_BLENDING_NONE"}function hE(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,r=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:r,maxMip:t}}function pE(s,e,t,r){const o=s.getContext(),l=t.defines;let u=t.vertexShader,f=t.fragmentShader;const h=aE(t),p=lE(t),v=uE(t),S=fE(t),x=hE(t),M=ZM(t),C=JM(l),D=o.createProgram();let y,_,L=t.glslVersion?"#version "+t.glslVersion+`
`:"";t.isRawShaderMaterial?(y=["#define SHADER_TYPE "+t.shaderType,"#define SHADER_NAME "+t.shaderName,C].filter(oo).join(`
`),y.length>0&&(y+=`
`),_=["#define SHADER_TYPE "+t.shaderType,"#define SHADER_NAME "+t.shaderName,C].filter(oo).join(`
`),_.length>0&&(_+=`
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const qE=Pe.forwardRef(({color:s="currentColor",size:e=24,strokeWidth:t=2,absoluteStrokeWidth:r,className:o="",children:l,iconNode:u,...f},h)=>Pe.createElement("svg",{ref:h,...$E,width:e,height:e,stroke:s,strokeWidth:r?Number(t)*24/Number(e):t,className:Mg("lucide",o),...f},[...u.map(([p,v])=>Pe.createElement(p,v)),...Array.isArray(l)?l:[l]]));/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Wt=(s,e)=>{const t=Pe.forwardRef(({className:r,...o},l)=>Pe.createElement(qE,{ref:l,iconNode:e,className:Mg(`lucide-${YE(s)}`,r),...o}));return t.displayName=`${s}`,t};/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const KE=Wt("ArrowDownLeft",[["path",{d:"M17 7 7 17",key:"15tmo1"}],["path",{d:"M17 17H7V7",key:"1org7z"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ZE=Wt("ArrowDownRight",[["path",{d:"m7 7 10 10",key:"1fmybs"}],["path",{d:"M17 7v10H7",key:"6fjiku"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Eg=Wt("ArrowDown",[["path",{d:"M12 5v14",key:"s699le"}],["path",{d:"m19 12-7 7-7-7",key:"1idqje"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const wg=Wt("ArrowLeft",[["path",{d:"m12 19-7-7 7-7",key:"1l729n"}],["path",{d:"M19 12H5",key:"x3x0zl"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const bg=Wt("ArrowRight",[["path",{d:"M5 12h14",key:"1ays0h"}],["path",{d:"m12 5 7 7-7 7",key:"xquz4c"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const JE=Wt("ArrowUpLeft",[["path",{d:"M7 17V7h10",key:"11bw93"}],["path",{d:"M17 17 7 7",key:"2786uv"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const QE=Wt("ArrowUpRight",[["path",{d:"M7 7h10v10",key:"1tivn9"}],["path",{d:"M7 17 17 7",key:"1vkiza"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Tg=Wt("ArrowUp",[["path",{d:"m5 12 7-7 7 7",key:"hav0vg"}],["path",{d:"M12 19V5",key:"x0mq9r"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ew=Wt("Building",[["rect",{width:"16",height:"20",x:"4",y:"2",rx:"2",ry:"2",key:"76otgf"}],["path",{d:"M9 22v-4h6v4",key:"r93iot"}],["path",{d:"M8 6h.01",key:"1dz90k"}],["path",{d:"M16 6h.01",key:"1x0f13"}],["path",{d:"M12 6h.01",key:"1vi96p"}],["path",{d:"M12 10h.01",key:"1nrarc"}],["path",{d:"M12 14h.01",key:"1etili"}],["path",{d:"M16 10h.01",key:"1m94wz"}],["path",{d:"M16 14h.01",key:"1gbofw"}],["path",{d:"M8 10h.01",key:"19clt8"}],["path",{d:"M8 14h.01",key:"6423bh"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Hl=Wt("Download",[["path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4",key:"ih7n3h"}],["polyline",{points:"7 10 12 15 17 10",key:"2ggqvy"}],["line",{x1:"12",x2:"12",y1:"15",y2:"3",key:"1vk2je"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const tw=Wt("Eye",[["path",{d:"M2.062 12.348a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 19.876 0 1 1 0 0 1 0 .696 10.75 10.75 0 0 1-19.876 0",key:"1nclc0"}],["circle",{cx:"12",cy:"12",r:"3",key:"1v7zrd"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const nw=Wt("HardDrive",[["line",{x1:"22",x2:"2",y1:"12",y2:"12",key:"1y58io"}],["path",{d:"M5.45 5.11 2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z",key:"oot6mr"}],["line",{x1:"6",x2:"6.01",y1:"16",y2:"16",key:"sgf278"}],["line",{x1:"10",x2:"10.01",y1:"16",y2:"16",key:"1l4acy"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const E0=Wt("Image",[["rect",{width:"18",height:"18",x:"3",y:"3",rx:"2",ry:"2",key:"1m3agn"}],["circle",{cx:"9",cy:"9",r:"2",key:"af1f0g"}],["path",{d:"m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21",key:"1xmnt7"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const lo=Wt("MapPin",[["path",{d:"M20 10c0 4.993-5.539 10.193-7.399 11.799a1 1 0 0 1-1.202 0C9.539 20.193 4 14.993 4 10a8 8 0 0 1 16 0",key:"1r0f0z"}],["circle",{cx:"12",cy:"10",r:"3",key:"ilqhr7"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const w0=Wt("Map",[["path",{d:"M14.106 5.553a2 2 0 0 0 1.788 0l3.659-1.83A1 1 0 0 1 21 4.619v12.764a1 1 0 0 1-.553.894l-4.553 2.277a2 2 0 0 1-1.788 0l-4.212-2.106a2 2 0 0 0-1.788 0l-3.659 1.83A1 1 0 0 1 3 19.381V6.618a1 1 0 0 1 .553-.894l4.553-2.277a2 2 0 0 1 1.788 0z",key:"169xi5"}],["path",{d:"M15 5.764v15",key:"1pn4in"}],["path",{d:"M9 3.236v15",key:"1uimfh"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const co=Wt("Menu",[["line",{x1:"4",x2:"20",y1:"12",y2:"12",key:"1e0a9i"}],["line",{x1:"4",x2:"20",y1:"6",y2:"6",key:"1owob3"}],["line",{x1:"4",x2:"20",y1:"18",y2:"18",key:"yk5zj1"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const b0=Wt("Minus",[["path",{d:"M5 12h14",key:"1ays0h"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const T0=Wt("Settings",[["path",{d:"M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.39a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1-1-1.74v-.5a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z",key:"1qme2f"}],["circle",{cx:"12",cy:"12",r:"3",key:"1v7zrd"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ag=Wt("TriangleAlert",[["path",{d:"m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3",key:"wmoenq"}],["path",{d:"M12 9v4",key:"juzpu7"}],["path",{d:"M12 17h.01",key:"p32p05"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const A0=Wt("Upload",[["path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4",key:"ih7n3h"}],["polyline",{points:"17 8 12 3 7 8",key:"t8dd8p"}],["line",{x1:"12",x2:"12",y1:"3",y2:"15",key:"widbto"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Cg=Wt("ZoomIn",[["circle",{cx:"11",cy:"11",r:"8",key:"4ej97u"}],["line",{x1:"21",x2:"16.65",y1:"21",y2:"16.65",key:"13gj7c"}],["line",{x1:"11",x2:"11",y1:"8",y2:"14",key:"1vmskp"}],["line",{x1:"8",x2:"14",y1:"11",y2:"11",key:"durymu"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Rg=Wt("ZoomOut",[["circle",{cx:"11",cy:"11",r:"8",key:"4ej97u"}],["line",{x1:"21",x2:"16.65",y1:"21",y2:"16.65",key:"13gj7c"}],["line",{x1:"8",x2:"14",y1:"11",y2:"11",key:"durymu"}]]),C0=(s,e,t)=>{const r=new Image;r.onload=()=>{let o=r.width,l=r.height;(o>e||l>e)&&(o>l?(l=Math.round(l*e/o),o=e):(o=Math.round(o*e/l),l=e));const u=document.createElement("canvas");u.width=o,u.height=l,u.getContext("2d").drawImage(r,0,0,o,l),t(u.toDataURL("image/jpeg",.7))},r.onerror=()=>t(s),r.src=s},dw=({direction:s,className:e})=>{const r={none:b0,up:Tg,down:Eg,left:wg,right:bg,"up-left":JE,"up-right":QE,"down-left":KE,"down-right":ZE}[s]||b0;return g.jsx(r,{className:e})},Gn=s=>{if(!s)return 0;const e=s.toUpperCase().trim();if(e.startsWith("B")){const r=parseInt(e.substring(1));return isNaN(r)?-99:-r}const t=parseInt(e);return isNaN(t)?0:t},Jr=s=>(s==null?void 0:s.bounds)||{blX:0,blY:0,trX:100,trY:100},Ci=s=>JSON.parse(JSON.stringify(s)),R0=(s,e)=>(s-e+540)%360-180,oc=s=>s==null||Number.isNaN(s)?null:(s%360+360)%360,N0=(s,e)=>s==null||e==null?null:oc(s-e),fw=s=>s&&typeof s.webkitCompassHeading=="number"?oc(s.webkitCompassHeading):s&&typeof s.alpha=="number"?oc(360-s.alpha):null,hw=(s,e)=>{if(!s||!e)return null;const t=s.physX??s.x,r=s.physY??s.y,o=e.physX??e.x,l=e.physY??e.y;return[t,r,o,l].some(u=>typeof u!="number")?null:oc(Math.atan2(o-t,r-l)*180/Math.PI)},P0=(s,e,t,r=1)=>{if(!s||s.length<2)return null;const o=new Vf(s),l=new Gf(o,Math.max(8,s.length*12),e,12,!1),u=new ts({color:t,transparent:r<1,opacity:r});return new Qn(l,u)},I0=(s,e)=>{if(!s||s.length===0)return null;let t=e;for(let l=0;l<s.length-1;l++){const u=s[l],f=s[l+1],h=Math.hypot(f.x-u.x,f.y-u.y);if(!(h<=.001)){if(t<=h){const p=t/h;return{x:u.x+(f.x-u.x)*p,y:u.y+(f.y-u.y)*p,angle:Math.atan2(f.y-u.y,f.x-u.x)}}t-=h}}const r=s[s.length-1],o=s[s.length-2]||r;return{x:r.x,y:r.y,angle:Math.atan2(r.y-o.y,r.x-o.x)}},D0=s=>!s||s.length<2?0:s.slice(1).reduce((e,t,r)=>{const o=s[r];return e+Math.hypot(t.x-o.x,t.y-o.y)},0),pw=s=>!s||s.length<2?0:s.slice(1).reduce((e,t,r)=>e+t.distanceTo(s[r]),0),mw=s=>!s||s.length<2?0:s.slice(1).reduce((e,t,r)=>{const o=s[r];return!o||!t?e:o.fId!==t.fId?e+5:e+Math.hypot((t.physX||0)-(o.physX||0),(t.physY||0)-(o.physY||0))},0),L0=(s,e,t)=>s+(e-s)*t,gw=(s,e,t=.36)=>s?{...e,x:L0(s.x,e.x,t),y:L0(s.y,e.y,t)}:e,U0=(s=[],e=[],t=.36)=>e.map((r,o)=>gw(s[o],r,t)),xw=s=>{if(!s||s.length<2)return null;const e=new Vf(s),t=Math.max(pw(s),.001),r=Math.max(4,Math.min(16,Math.ceil(t/.34))),o=[],l=new Ts;for(let u=0;u<r;u++){const f=new Ts,h=new Qn(new sc(.14,.34,24),new ts({color:16777215,transparent:!0,opacity:.22})),p=new Qn(new sc(.09,.28,24),new ts({color:16777215,transparent:!0,opacity:.98}));f.add(h),f.add(p),f.userData.flowOffset=u/r,o.push(f),l.add(f)}return l.userData.flow={curve:e,arrows:o},l},vw=(s,e)=>{var r;const t=(r=s==null?void 0:s.userData)==null?void 0:r.flow;t&&t.arrows.forEach(o=>{const l=(o.userData.flowOffset+e*28e-5)%1,u=t.curve.getPointAt(l),f=t.curve.getTangentAt(l).normalize();o.position.copy(u),o.position.y+=.11,o.quaternion.setFromUnitVectors(new ie(0,1,0),f),o.children.forEach((h,p)=>{h.material.opacity=(p===0?.16:.58)+(p===0?.18:.4)*Math.sin(l*Math.PI)})})},pa=(s="新導引專案")=>({projectName:s,lerpFactor:15}),uo=()=>[{id:`b_${Date.now()}`,name:"預設場域",floors:[{id:`f_${Date.now()}`,name:"1F",imageUrl:null,markers:[],waypoints:[],edges:[],bounds:{blX:0,blY:0,trX:100,trY:100}}]}],_w=(s="新導引專案",e="")=>({id:`project_${Date.now()}_${Math.random().toString(36).slice(2,7)}`,name:s,description:e,updatedAt:new Date().toISOString(),systemConfig:pa(s),buildings:uo()}),jl=s=>{var e,t,r,o,l,u;return{id:((e=s==null?void 0:s.project)==null?void 0:e.id)||"published",name:((t=s==null?void 0:s.project)==null?void 0:t.name)||((r=s==null?void 0:s.systemConfig)==null?void 0:r.projectName)||"AR導覽",description:((o=s==null?void 0:s.project)==null?void 0:o.description)||"",updatedAt:((l=s==null?void 0:s.project)==null?void 0:l.updatedAt)||new Date().toISOString(),systemConfig:{...pa(((u=s==null?void 0:s.project)==null?void 0:u.name)||"AR導覽"),...(s==null?void 0:s.systemConfig)||{}},buildings:Array.isArray(s==null?void 0:s.buildings)?s.buildings:[]}};function yw({embedded:s=!1,initialTab:e="map",publicOnly:t=!1}){var it,Je,bt,kt;const[r,o]=Pe.useState(e),[l,u]=Pe.useState(!1),[f,h]=Pe.useState({isOpen:!1,title:"",placeholder:"",onSubmit:null,defaultValue:""}),[p,v]=Pe.useState({isOpen:!1,title:"",message:"",onConfirm:null}),[S,x]=Pe.useState({isOpen:!1,message:""}),[M,C]=Pe.useState(!1),[D,y]=Pe.useState({isOpen:!1,blX:0,blY:0,trX:100,trY:100}),_=Pe.useRef(!1),[L,R]=Pe.useState(()=>{if(t)return[jl({})];try{const F=localStorage.getItem("arManager_projects");if(F){const W=JSON.parse(F);if(Array.isArray(W)&&W.length>0)return W}}catch(F){console.error("Project load error:",F)}let w=pa("預設導引專案"),k=uo();try{const F=localStorage.getItem("arManager_config");F&&(w={...w,...JSON.parse(F)});const W=localStorage.getItem("arManager_buildings");W&&(k=JSON.parse(W))}catch(F){console.error("Legacy AR data migration error:",F)}return[{id:`project_${Date.now()}`,name:w.projectName||"預設導引專案",description:"由既有 AR 導引資料自動建立",updatedAt:new Date().toISOString(),systemConfig:w,buildings:k}]}),[P,V]=Pe.useState((it=L[0])==null?void 0:it.id),I=L.find(w=>w.id===P)||L[0],[O,T]=Pe.useState(()=>Ci((I==null?void 0:I.systemConfig)||pa())),[N,Y]=Pe.useState(()=>Ci((I==null?void 0:I.buildings)||uo())),[H,Q]=Pe.useState((Je=N[0])==null?void 0:Je.id),[re,pe]=Pe.useState((kt=(bt=N[0])==null?void 0:bt.floors[0])==null?void 0:kt.id),[X,oe]=Pe.useState(""),[J,ee]=Pe.useState(null),[he,ce]=Pe.useState(null),[B,le]=Pe.useState(null),[et,st]=Pe.useState(!1),[Te,ue]=Pe.useState(!1),[be,Se]=Pe.useState(!1),[Fe,ot]=Pe.useState(null),[gt,Et]=Pe.useState(null),[St,Ot]=Pe.useState(!1),[Kt,Tt]=Pe.useState({x:0,y:0}),[zt,Nt]=Pe.useState({x:0,y:0}),[Gt,q]=Pe.useState(!1),[It,wt]=Pe.useState(!1),[At,qe]=Pe.useState([]),[Ht,U]=Pe.useState(!1),[E,ae]=Pe.useState([]),[Me,Ae]=Pe.useState([]),Ve=Pe.useRef(null),We=Pe.useRef(null),xe=Pe.useRef(null),we=Pe.useRef(null),[Ce,tt]=Pe.useState({x:0,y:0,scale:1}),Ye=w=>{var F,W,Re;if(!Array.isArray(w==null?void 0:w.buildings)||w.buildings.length===0)throw new Error("雲端目前沒有可載入的 AR 平面圖資料。");const k=jl(w);return R([k]),V(k.id),T(Ci(k.systemConfig)),Y(Ci(k.buildings)),Q((F=k.buildings[0])==null?void 0:F.id),pe((Re=(W=k.buildings[0])==null?void 0:W.floors[0])==null?void 0:Re.id),oe(""),ee(null),ce(null),ot(null),tt({x:0,y:0,scale:1}),localStorage.setItem("arManager_lastCloudSyncAt",k.updatedAt||new Date().toISOString()),k};Pe.useEffect(()=>{const w=k=>{var W;const F=(W=k==null?void 0:k.detail)==null?void 0:W.tab;["map","list","settings","export"].includes(F)&&_e(F)};return window.addEventListener("ar-manager:set-tab",w),()=>window.removeEventListener("ar-manager:set-tab",w)},[]),Pe.useEffect(()=>{if(!t)try{localStorage.setItem("arManager_projects",JSON.stringify(L))}catch(w){w.name==="QuotaExceededError"&&x({isOpen:!0,message:"專案資料太大，請先匯出 JSON 或移除不需要的圖片資料。"})}},[L,t]),Pe.useEffect(()=>{if(!t)return;let w=!1;return(async()=>{const F=await fetch(`/api/ar-content?ts=${Date.now()}`,{cache:"no-store"});if(F.ok)return F.json();const W=await fetch(`/ar-data.json?ts=${Date.now()}`,{cache:"no-store"});if(!W.ok)throw new Error(`Unable to load AR data: ${W.status}`);return W.json()})().then(F=>{var Re,ve,Ue;if(w)return;const W=jl(F);R([W]),V(W.id),T(Ci(W.systemConfig)),Y(Ci(W.buildings)),Q((Re=W.buildings[0])==null?void 0:Re.id),pe((Ue=(ve=W.buildings[0])==null?void 0:ve.floors[0])==null?void 0:Ue.id)}).catch(F=>{console.warn("Published AR data unavailable",F),w||(R([jl({})]),T(pa("AR導覽")),Y([]))}),()=>{w=!0}},[t]),Pe.useEffect(()=>{if(t||localStorage.getItem("arManager_projects"))return;let w=!1;return fetch(`/api/ar-content?ts=${Date.now()}`,{cache:"no-store"}).then(k=>{if(!k.ok)throw new Error(`Unable to load AR data: ${k.status}`);return k.json()}).then(k=>{w||!Array.isArray(k==null?void 0:k.buildings)||k.buildings.length===0||Ye(k)}).catch(k=>console.warn("Published AR admin seed unavailable",k)),()=>{w=!0}},[t]),Pe.useEffect(()=>{var k,F,W;if(t||!I)return;_.current=!0;const w=Ci(I.buildings||uo());T(Ci(I.systemConfig||pa(I.name))),Y(w),Q((k=w[0])==null?void 0:k.id),pe((W=(F=w[0])==null?void 0:F.floors[0])==null?void 0:W.id),ee(null),ce(null),oe(""),tt({x:0,y:0,scale:1})},[P,t]),Pe.useEffect(()=>{if(!t&&P){if(_.current){_.current=!1;return}R(w=>w.map(k=>k.id===P?{...k,name:O.projectName||k.name,systemConfig:Ci(O),buildings:Ci(N),updatedAt:new Date().toISOString()}:k))}},[P,N,O,t]),Pe.useEffect(()=>{if(!t)try{localStorage.setItem("arManager_buildings",JSON.stringify(N))}catch(w){w.name==="QuotaExceededError"&&x({isOpen:!0,message:"⚠️ 瀏覽器本地暫存空間已滿！"})}},[N,t]),Pe.useEffect(()=>{if(!t)try{localStorage.setItem("arManager_config",JSON.stringify(O))}catch(w){console.error("Config save error:",w)}},[O,t]),Pe.useEffect(()=>{var k;const w=N.find(F=>F.id===H);w?w.floors.find(F=>F.id===re)||w.floors.length>0&&pe(w.floors[0].id):N.length>0&&(Q(N[0].id),pe((k=N[0].floors[0])==null?void 0:k.id))},[N,H,re]),Pe.useEffect(()=>{X===re&&oe("")},[re,X]),Pe.useEffect(()=>{st(!1)},[J,he]),Pe.useEffect(()=>{sessionStorage.getItem("ar_permissions_asked")||C(!0)},[]);const Oe=async()=>{try{navigator.mediaDevices&&navigator.mediaDevices.getUserMedia&&(await navigator.mediaDevices.getUserMedia({video:{facingMode:"environment"}})).getTracks().forEach(k=>k.stop())}catch{}try{typeof DeviceOrientationEvent<"u"&&typeof DeviceOrientationEvent.requestPermission=="function"&&await DeviceOrientationEvent.requestPermission()}catch{}sessionStorage.setItem("ar_permissions_asked","true"),C(!1)},Ke=N.find(w=>w.id===H)||N[0],He=Ke==null?void 0:Ke.floors.find(w=>w.id===re),Pt=(He==null?void 0:He.markers)||[],$=(He==null?void 0:He.waypoints)||[],Ge=(He==null?void 0:He.edges)||[],me=Jr(He),lt=(w,k,F=!0)=>{Y(W=>{let Re=null,ve=null,Ue=null;if(W.forEach(rt=>rt.floors.forEach(Yt=>{const Ut=F?Yt.markers:Yt.waypoints,un=Ut==null?void 0:Ut.find(nn=>nn.id===w);un&&(Re=un,ve=rt.id,Ue=Yt)})),!Re)return W;const ft=k.shaftId!==void 0?k.shaftId:Re.shaftId,ut=(k.isVerticalShaft!==void 0?k.isVerticalShaft:Re.isVerticalShaft)&&ft,mt=Jr(Ue);return W.map(rt=>rt.id!==ve&&!ut?rt:{...rt,floors:rt.floors.map(Yt=>{let Ut=F?[...Yt.markers||[]]:[...Yt.waypoints||[]];const un=nn=>{const $n={...nn,...k};if((k.x!==void 0||k.y!==void 0)&&Yt.id!==Ue.id){const ht=Jr(Yt);if(k.x!==void 0){const Bt=mt.blX+k.x*(mt.trX-mt.blX);$n.x=ht.trX!==ht.blX?(Bt-ht.blX)/(ht.trX-ht.blX):.5}if(k.y!==void 0){const Bt=mt.trY-k.y*(mt.trY-mt.blY);$n.y=ht.trY!==ht.blY?(ht.trY-Bt)/(ht.trY-ht.blY):.5}}return $n};return ut?Ut=Ut.map(nn=>nn.shaftId===ft||nn.id===w?un(nn):nn):Ut=Ut.map(nn=>nn.id===w?un(nn):nn),F?{...Yt,markers:Ut}:{...Yt,waypoints:Ut}})})})},ke=(w,k,F)=>lt(w,{[k]:F},!0),ye=(w,k,F)=>lt(w,{[k]:F},!1),ct=(w,k,F=!0)=>{if(k){const W=F?"shaft_m_":"shaft_wp_",ve={isVerticalShaft:!0,shaftId:w.shaftId||`${W}${Date.now()}`,linkedFloorIds:[re]};F||(ve.sourceFloorId=re),lt(w.id,ve,F)}else{const W=w.shaftId;Y(Re=>Re.map(ve=>ve.id!==H?ve:{...ve,floors:ve.floors.map(Ue=>{const ft=at=>(at||[]).filter(ut=>!(Ue.id!==re&&ut.shaftId===W)).map(ut=>ut.id===w.id?{...ut,isVerticalShaft:!1,shaftId:null,linkedFloorIds:[],sourceFloorId:null}:ut);return F?{...Ue,markers:ft(Ue.markers)}:{...Ue,waypoints:ft(Ue.waypoints)}})}))}},Mt=(w,k,F,W=!0)=>{const Re=w.shaftId,ve=w.linkedFloorIds||[re],Ue=F?[...ve,k]:ve.filter(ft=>ft!==k);Y(ft=>ft.map(at=>at.id!==H?at:{...at,floors:at.floors.map(ut=>{let mt=W?[...ut.markers||[]]:[...ut.waypoints||[]];if(F&&ut.id===k){const rt=Jr(ut),Yt=Jr(He),Ut=Yt.blX+w.x*(Yt.trX-Yt.blX),un=Yt.trY-w.y*(Yt.trY-Yt.blY),nn=rt.trX!==rt.blX?(Ut-rt.blX)/(rt.trX-rt.blX):.5,$n=rt.trY!==rt.blY?(rt.trY-un)/(rt.trY-rt.blY):.5,ht=W?"marker_":"wp_";mt.push({...w,id:`${ht}${Date.now()}_${Math.random().toString(36).substr(2,5)}_${ut.id}`,x:nn,y:$n,linkedFloorIds:Ue})}else!F&&ut.id===k?mt=mt.filter(rt=>rt.shaftId!==Re):mt=mt.map(rt=>rt.shaftId===Re?{...rt,linkedFloorIds:Ue}:rt);return W?{...ut,markers:mt}:{...ut,waypoints:mt}})}))},Xt=w=>{let k=null,F=new Set([w]);N.forEach(W=>W.floors.forEach(Re=>{var ve;Re.markers.forEach(Ue=>{Ue.id===w&&Ue.isVerticalShaft&&(k=Ue.shaftId)}),(ve=Re.waypoints)==null||ve.forEach(Ue=>{Ue.id===w&&Ue.isVerticalShaft&&(k=Ue.shaftId)})})),k&&N.forEach(W=>W.floors.forEach(Re=>{var ve;Re.markers.forEach(Ue=>{Ue.shaftId===k&&F.add(Ue.id)}),(ve=Re.waypoints)==null||ve.forEach(Ue=>{Ue.shaftId===k&&F.add(Ue.id)})})),Y(W=>W.map(Re=>({...Re,floors:Re.floors.map(ve=>({...ve,markers:(ve.markers||[]).filter(Ue=>!F.has(Ue.id)),waypoints:(ve.waypoints||[]).filter(Ue=>!F.has(Ue.id)),edges:(ve.edges||[]).filter(Ue=>!F.has(Ue.start)&&!F.has(Ue.end))}))}))),F.has(J)&&ee(null),F.has(he)&&ce(null),F.has(Fe)&&(ot(null),Et(null)),st(!1)},$t=()=>{h({isOpen:!0,title:"新增建築物",placeholder:"請輸入新建築物名稱 (例如: 行政大樓)",defaultValue:"新建築物",onSubmit:w=>{if(!w)return;const k=`b_${Date.now()}`,F=`f_${Date.now()}`;Y(W=>[...W,{id:k,name:w,floors:[{id:F,name:"1F",imageUrl:null,markers:[],waypoints:[],edges:[],bounds:{blX:0,blY:0,trX:100,trY:100}}]}]),Q(k),pe(F)}})},En=()=>{Ke&&h({isOpen:!0,title:`新增 ${Ke.name} 的樓層`,placeholder:"請輸入新樓層名稱 (例如: 2F)",defaultValue:"新樓層",onSubmit:w=>{if(!w)return;const k=`f_${Date.now()}`,F=He?{...Jr(He)}:{blX:0,blY:0,trX:100,trY:100};Y(W=>W.map(Re=>Re.id===H?{...Re,floors:[...Re.floors,{id:k,name:w,imageUrl:null,markers:[],waypoints:[],edges:[],bounds:F}]}:Re)),pe(k)}})},In=w=>{const k=w.target.files[0],F=w.target;if(k&&H&&re){const W=H,Re=re,ve=new FileReader;ve.onload=Ue=>{C0(Ue.target.result,1600,ft=>{Y(at=>at.map(ut=>ut.id===W?{...ut,floors:ut.floors.map(mt=>mt.id===Re?{...mt,imageUrl:ft}:mt)}:ut)),q(!1)})},ve.readAsDataURL(k)}F.value=""},li=(w,k)=>{const F=`wp_${Date.now()}_${Math.random().toString(36).substr(2,5)}`,W={id:F,x:w,y:k,isVerticalShaft:!1,shaftId:null,linkedFloorIds:[],sourceFloorId:re};Y(Re=>Re.map(ve=>ve.id===H?{...ve,floors:ve.floors.map(Ue=>{if(Ue.id!==re)return Ue;const ft=Fe?[...Ue.edges||[],{id:`edge_${Date.now()}_${Math.random().toString(36).substr(2,5)}`,start:Fe,end:F}]:Ue.edges||[];return{...Ue,waypoints:[...Ue.waypoints||[],W],edges:ft}})}:ve)),ot(F)},_i=w=>{if(Fe===w){ot(null),Et(null);return}Fe&&Fe!==w&&(Ge.some(F=>F.start===Fe&&F.end===w||F.end===Fe&&F.start===w)||Y(F=>F.map(W=>W.id===H?{...W,floors:W.floors.map(Re=>Re.id===re?{...Re,edges:[...Re.edges||[],{id:`edge_${Date.now()}_${Math.random().toString(36).substr(2,5)}`,start:Fe,end:w}]}:Re)}:W))),ot(w)},Ii=(w,k)=>{for(let W of Pt)if(Math.hypot(W.x-w,W.y-k)<.03)return W.id;for(let W of $)if(Math.hypot(W.x-w,W.y-k)<.03)return W.id;return null};Pe.useEffect(()=>{const w=k=>{k.key==="Escape"&&Te&&(ot(null),Et(null))};return window.addEventListener("keydown",w),()=>window.removeEventListener("keydown",w)},[Te]);const Fn=(w,k)=>{const F={},W=[],Re={};N.forEach(ht=>{ht.floors.forEach(Bt=>{var Nr,Fi;const pn=Bt.bounds||{blX:0,blY:0,trX:100,trY:100},Ui=(an,_o)=>({physX:pn.blX+an*(pn.trX-pn.blX),physY:pn.trY-_o*(pn.trY-pn.blY)});Bt.markers.forEach(an=>{F[an.id]={...an,...Ui(an.x,an.y),fId:Bt.id,fName:Bt.name},an.isVerticalShaft&&an.shaftId&&(Re[an.shaftId]||(Re[an.shaftId]=[]),Re[an.shaftId].push(an.id))}),(Nr=Bt.waypoints)==null||Nr.forEach(an=>{F[an.id]={...an,...Ui(an.x,an.y),fId:Bt.id,fName:Bt.name},an.isVerticalShaft&&an.shaftId&&(Re[an.shaftId]||(Re[an.shaftId]=[]),Re[an.shaftId].push(an.id))}),(Fi=Bt.edges)==null||Fi.forEach(an=>W.push(an))})});const ve={};Object.keys(F).forEach(ht=>{ve[ht]={}}),W.forEach(ht=>{if(F[ht.start]&&F[ht.end]){const Bt=Math.hypot(F[ht.start].physX-F[ht.end].physX,F[ht.start].physY-F[ht.end].physY);ve[ht.start][ht.end]=Bt,ve[ht.end][ht.start]=Bt}}),Object.values(Re).forEach(ht=>{for(let Bt=0;Bt<ht.length;Bt++)for(let pn=Bt+1;pn<ht.length;pn++)ve[ht[Bt]][ht[pn]]=5,ve[ht[pn]][ht[Bt]]=5});const Ue=ht=>Object.keys(ve[ht]).length>0;let ft=null,at=1/0,ut=null,mt=1/0;if(Object.values(F).forEach(ht=>{if(Ue(ht.id)){if(ht.fId===w.fId){const Bt=Math.hypot(ht.x-w.x,ht.y-w.y);Bt<at&&(at=Bt,ft=ht.id)}if(ht.fId===k.fId){const Bt=Math.hypot(ht.x-k.x,ht.y-k.y);Bt<mt&&(mt=Bt,ut=ht.id)}}}),!ft||!ut){x({isOpen:!0,message:"無法找到鄰近的路網節點。請確認起點與終點的樓層皆有繪製路網路線！"}),ae([]),Ae([]);return}const rt={},Yt={},Ut=new Set(Object.keys(F));for(Object.keys(F).forEach(ht=>{rt[ht]=1/0,Yt[ht]=null}),rt[ft]=0;Ut.size>0;){let ht=null;if(Ut.forEach(Bt=>{(ht===null||rt[Bt]<rt[ht])&&(ht=Bt)}),rt[ht]===1/0||ht===ut)break;Ut.delete(ht),Object.entries(ve[ht]).forEach(([Bt,pn])=>{if(Ut.has(Bt)){const Ui=rt[ht]+pn;Ui<rt[Bt]&&(rt[Bt]=Ui,Yt[Bt]=ht)}})}const un=[];let nn=ut;for(;nn;)un.unshift(nn),nn=Yt[nn];if(un.length===0||un[0]!==ft){x({isOpen:!0,message:"無法計算跨樓層路徑，請確認上下樓的電梯/樓梯節點有正確連接到路網！"}),ae([]),Ae([]);return}const $n=[{x:w.x,y:w.y,fId:w.fId,fName:w.fName,isVirtual:!0},...un.map(ht=>F[ht]),{x:k.x,y:k.y,fId:k.fId,fName:k.fName,isVirtual:!0}];Ae($n)};Pe.useEffect(()=>{const w=Ve.current;if(!w||r!=="map")return;const k=F=>{F.preventDefault();const W=w.getBoundingClientRect(),Re=F.clientX-W.left,ve=F.clientY-W.top,Ue=F.deltaY<0?1.1:.9;tt(ft=>{const at=Math.max(.1,Math.min(10,ft.scale*Ue)),ut=at/ft.scale;return{x:Re-(Re-ft.x)*ut,y:ve-(ve-ft.y)*ut,scale:at}})};return w.addEventListener("wheel",k,{passive:!1}),()=>w.removeEventListener("wheel",k)},[r]);const Wn=w=>{w.button!==void 0&&w.button!==0||w.target.closest(".marker-pin")||w.target.closest(".waypoint-pin")||(Ot(!0),Tt({x:w.clientX-Ce.x,y:w.clientY-Ce.y}),Nt({x:w.clientX,y:w.clientY}),w.target.setPointerCapture(w.pointerId))},Di=w=>{if(St)tt(k=>({...k,x:w.clientX-Kt.x,y:w.clientY-Kt.y}));else if(Te&&Fe&&We.current){const k=We.current.getBoundingClientRect();let F=Math.max(0,Math.min(1,(w.clientX-k.left)/k.width)),W=Math.max(0,Math.min(1,(w.clientY-k.top)/k.height));Et({x:F,y:W})}else if(B&&We.current){const k=We.current.getBoundingClientRect();let F=Math.max(0,Math.min(1,(w.clientX-k.left)/k.width)),W=Math.max(0,Math.min(1,(w.clientY-k.top)/k.height));B.startsWith("marker_")?(ke(B,"x",F),ke(B,"y",W)):B.startsWith("wp_")&&(ye(B,"x",F),ye(B,"y",W))}},Xn=w=>{if(St&&(Ot(!1),w.target.releasePointerCapture(w.pointerId),Math.hypot(w.clientX-zt.x,w.clientY-zt.y)<5)){if(!(He!=null&&He.imageUrl)||!We.current)return;const F=We.current.getBoundingClientRect();let W=Math.max(0,Math.min(1,(w.clientX-F.left)/F.width)),Re=Math.max(0,Math.min(1,(w.clientY-F.top)/F.height));if(Ht){const ve={x:W,y:Re,fId:re,fName:He==null?void 0:He.name},Ue=E.length>=2?[ve]:[...E,ve];ae(Ue),Ue.length===1&&Ae([]),Ue.length===2&&Fn(Ue[0],Ue[1])}else if(Te){const ve=Ii(W,Re);ve?_i(ve):li(W,Re)}else if(Gt){const ve=N.reduce((ft,at)=>ft+at.floors.reduce((ut,mt)=>ut+mt.markers.length,0),0),Ue={id:`marker_${Date.now()}_${Math.random().toString(36).substr(2,5)}`,code:`N${ve+1}`,title:"新增辨識點",description:"",arrowDirection:"none",isVerticalShaft:!1,shaftId:null,linkedFloorIds:[],x:W,y:Re,imageUrl:null,enabled:!0,recognitionStatus:"untested"};Y(ft=>ft.map(at=>at.id===H?{...at,floors:at.floors.map(ut=>ut.id===re?{...ut,markers:[...ut.markers,Ue]}:ut)}:at)),ee(Ue.id),ce(null),q(!1)}else It?qe(ve=>ve.length>=2?[{x:W,y:Re}]:[...ve,{x:W,y:Re}]):(ee(null),ce(null))}},gn=w=>{const k=w.target.files[0],F=w.target;if(k&&J){const W=J,Re=new FileReader;Re.onload=ve=>{C0(ve.target.result,800,Ue=>{ke(W,"imageUrl",Ue),ke(W,"recognitionStatus","untested")})},Re.readAsDataURL(k)}F.value=""},Yn=(w,k,F)=>{Q(w),pe(k),ee(F),ce(null),o("map")},ci=async()=>{const w={version:"7.0",project:{id:P,name:O.projectName||(I==null?void 0:I.name)||"AR導覽",description:(I==null?void 0:I.description)||"",updatedAt:new Date().toISOString()},systemConfig:Ci(O),buildings:Ci(N)};R(k=>k.map(F=>F.id===P?{...F,name:w.project.name,systemConfig:w.systemConfig,buildings:w.buildings,updatedAt:w.project.updatedAt}:F));try{const k=await fetch("/api/save-ar-content",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(w)}),F=await k.json().catch(()=>({}));if(!k.ok)throw new Error(F.error||`Save failed: ${k.status}`);localStorage.setItem("arManager_lastCloudSyncAt",w.project.updatedAt),x({isOpen:!0,message:`「${w.project.name}」已儲存到 Web 端。民眾端會透過 /api/ar-content 讀取最新平面圖、AR 點位與路網資料。`})}catch(k){x({isOpen:!0,message:`已儲存在後台暫存，但發布到網站失敗：${k.message}`})}},Li=async()=>{try{const w=await fetch(`/api/ar-content?ts=${Date.now()}`,{cache:"no-store"});if(!w.ok)throw new Error(`Load failed: ${w.status}`);const k=await w.json(),F=Ye(k);x({isOpen:!0,message:`已從雲端載入「${F.name}」。桌機與手機現在會使用同一份已上架的平面圖、AR 點位與路網資料。`})}catch(w){x({isOpen:!0,message:`無法從雲端載入 AR 資料：${w.message}`})}},yi=()=>{h({isOpen:!0,title:"新增 AR 導引專案",placeholder:"請輸入場域或導引服務名稱",defaultValue:`導引專案 ${L.length+1}`,onSubmit:w=>{if(!w)return;const k=_w(w);R(F=>[...F,k]),V(k.id),o("map")}})},ui=()=>{h({isOpen:!0,title:"編輯專案名稱",placeholder:"請輸入專案名稱",defaultValue:(I==null?void 0:I.name)||O.projectName||"",onSubmit:w=>{w&&(T(k=>({...k,projectName:w})),R(k=>k.map(F=>F.id===P?{...F,name:w,systemConfig:{...F.systemConfig,projectName:w},updatedAt:new Date().toISOString()}:F)))}})},lr=()=>{if(L.length<=1){x({isOpen:!0,message:"至少需要保留一個 AR 導引專案。"});return}v({isOpen:!0,title:"刪除 AR 導引專案",message:`確定要刪除「${(I==null?void 0:I.name)||O.projectName}」嗎？此專案內的平面圖、路徑與 AR 點位都會一併移除。`,onConfirm:()=>{R(w=>{var F;const k=w.filter(W=>W.id!==P);return V((F=k[0])==null?void 0:F.id),k})}})},cr=()=>{Y(uo()),ee(null),ce(null),tt({x:0,y:0,scale:1}),q(!1),ue(!1),Se(!1),ot(null),Et(null),U(!1),ae([]),Ae([]),x({isOpen:!0,message:"目前專案的 AR 資料已清除。"})},j=()=>{const w=(O.projectName||(I==null?void 0:I.name)||"ar_project").replace(/[^\w\u4e00-\u9fff-]+/g,"_"),k="data:text/json;charset=utf-8,"+encodeURIComponent(JSON.stringify({version:"7.0",project:{id:P,name:O.projectName||(I==null?void 0:I.name),description:(I==null?void 0:I.description)||"",updatedAt:I==null?void 0:I.updatedAt},systemConfig:O,buildings:N},null,2)),F=document.createElement("a");F.setAttribute("href",k),F.setAttribute("download",`${w}_ar_config_v7.json`),document.body.appendChild(F),F.click(),F.remove()},Le=()=>{if(!(He!=null&&He.imageUrl)||!Ve.current||!We.current){tt({x:0,y:0,scale:1});return}const w=Ve.current,k=We.current.querySelector("img");if(!k||k.naturalWidth===0)return;const{width:F,height:W}=w.getBoundingClientRect(),Re=Math.min(F/k.naturalWidth,W/k.naturalHeight,1)*.9;tt({x:(F-k.naturalWidth*Re)/2,y:(W-k.naturalHeight*Re)/2,scale:Re})},_e=w=>{o(w),u(!1),q(!1),wt(!1),ue(!1),Se(!1),ot(null),Et(null),U(!1),ae([]),Ae([])};let Ne=null,nt=null;N.forEach(w=>w.floors.forEach(k=>{var F;k.markers.forEach(W=>{W.id===J&&(Ne=W,w.name,k.name)}),(F=k.waypoints)==null||F.forEach(W=>{W.id===he&&(nt=W,w.name,k.name)})}));let b=0,G=0;const se=document.getElementById("current-map-image"),Z=me.trX-me.blX,ne=me.trY-me.blY;if(se&&Z>0){const w=se.offsetWidth*Ce.scale;if(w>0){const k=Z/w,F=100*k;b=[.5,1,2,5,10,20,50,100,200,500,1e3,2e3,5e3].slice().reverse().find(Re=>Re<=F)||.5,G=b/k}}const Ie=N.reduce((w,k)=>w+k.floors.reduce((F,W)=>F+(W.markers||[]).length,0),0),Xe=N.reduce((w,k)=>w+k.floors.length,0),Ee=()=>g.jsxs("div",{className:"bg-slate-900 border border-slate-800 rounded-xl p-4 md:p-5 shadow-lg mb-5",children:[g.jsxs("div",{className:"flex flex-col xl:flex-row xl:items-center justify-between gap-4",children:[g.jsxs("div",{className:"min-w-0",children:[g.jsx("div",{className:"text-xs font-bold text-cyan-400 tracking-widest uppercase mb-1",children:"AR 導引專案"}),g.jsxs("div",{className:"flex flex-col sm:flex-row sm:items-center gap-3",children:[g.jsx("select",{value:P,onChange:w=>V(w.target.value),className:"bg-slate-950 border border-slate-700 rounded-lg px-3 py-2 text-sm text-slate-100 focus:outline-none focus:border-cyan-500 min-w-[220px]",children:L.map(w=>g.jsx("option",{value:w.id,className:"bg-slate-950",children:w.name},w.id))}),g.jsxs("div",{className:"text-xs text-slate-500",children:["共 ",L.length," 個專案 · ",N.length," 棟建築 · ",Xe," 個樓層 · ",Ie," 個 AR 點位"]})]})]}),g.jsxs("div",{className:"grid grid-cols-2 sm:flex sm:flex-wrap gap-2 w-full xl:w-auto",children:[g.jsxs("button",{onClick:yi,className:"inline-flex items-center justify-center gap-2 bg-cyan-500 hover:bg-cyan-400 text-slate-950 font-bold px-3 py-2 rounded-lg text-xs transition-colors",children:[g.jsx(Gl,{className:"w-4 h-4"}),"新增專案"]}),g.jsxs("button",{onClick:ui,className:"inline-flex items-center justify-center gap-2 bg-slate-800 hover:bg-slate-700 text-slate-200 border border-slate-700 px-3 py-2 rounded-lg text-xs transition-colors",children:[g.jsx(Nd,{className:"w-4 h-4"}),"編輯"]}),g.jsxs("button",{onClick:ci,className:"inline-flex items-center justify-center gap-2 bg-green-500/10 hover:bg-green-500/20 text-green-400 border border-green-500/30 px-3 py-2 rounded-lg text-xs transition-colors",children:[g.jsx(Jl,{className:"w-4 h-4"}),"儲存"]}),g.jsxs("button",{onClick:ci,className:"inline-flex items-center justify-center gap-2 bg-blue-500/10 hover:bg-blue-500/20 text-blue-300 border border-blue-500/30 px-3 py-2 rounded-lg text-xs transition-colors",title:"把目前這台裝置的 AR 資料同步到雲端，讓其他裝置可以載入",children:[g.jsx(A0,{className:"w-4 h-4"}),"同步雲端"]}),g.jsxs("button",{onClick:Li,className:"inline-flex items-center justify-center gap-2 bg-amber-500/10 hover:bg-amber-500/20 text-amber-300 border border-amber-500/30 px-3 py-2 rounded-lg text-xs transition-colors",title:"從雲端載入已上架的 AR 資料，會覆蓋目前後台顯示的本機暫存",children:[g.jsx(Hl,{className:"w-4 h-4"}),"從雲端載入"]}),g.jsxs("button",{onClick:lr,className:"inline-flex items-center justify-center gap-2 bg-red-500/10 hover:bg-red-500/20 text-red-400 border border-red-500/30 px-3 py-2 rounded-lg text-xs transition-colors",children:[g.jsx(Pd,{className:"w-4 h-4"}),"刪除"]})]})]}),g.jsx("div",{className:"mt-3 text-xs text-slate-500",children:"每個專案都會獨立保存平面圖、路徑節點、AR 導引點與系統設定。切換專案後，下方維護區會載入該場域自己的資料。"})]}),Ze=()=>{const w=new Set,k=N.flatMap(F=>F.floors.flatMap(W=>(W.markers||[]).reduce((Re,ve)=>{if(ve.isVerticalShaft&&ve.shaftId){if(w.has(ve.shaftId))return Re;w.add(ve.shaftId)}return Re.push({...ve,bId:F.id,fId:W.id,buildingName:F.name,floorName:W.name}),Re},[])));return g.jsx("div",{className:"flex-1 p-4 md:p-8 overflow-auto bg-slate-950",children:g.jsxs("div",{className:"max-w-7xl mx-auto",children:[Ee(),g.jsxs("div",{className:"flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4",children:[g.jsxs("div",{className:"flex items-center",children:[g.jsx("button",{className:"md:hidden mr-3 text-slate-400 hover:text-white shrink-0",onClick:()=>u(!0),children:g.jsx(co,{className:"w-6 h-6"})}),g.jsxs("h2",{className:"text-xl md:text-2xl font-bold text-slate-200 flex items-center",children:[g.jsx(lo,{className:"mr-2 md:mr-3 text-cyan-400"})," 點位總覽"]})]}),g.jsxs("span",{className:"bg-slate-800 text-cyan-400 px-4 py-1.5 rounded-full text-xs md:text-sm font-bold border border-cyan-500/30",children:["共 ",k.length," 組節點"]})]}),k.length===0?g.jsxs("div",{className:"bg-slate-900 border border-slate-800 rounded-xl p-8 md:p-12 text-center text-slate-500 flex flex-col items-center",children:[g.jsx(lo,{className:"w-12 h-12 md:w-16 md:h-16 mb-4 opacity-30"}),g.jsx("p",{className:"text-base md:text-lg mb-2",children:"目前沒有任何點位資料"}),g.jsx("button",{onClick:()=>_e("map"),className:"mt-6 bg-cyan-500/10 hover:bg-cyan-500/20 text-cyan-400 border border-cyan-500/30 px-6 py-2 rounded-lg transition-all text-sm",children:"前往平面圖"})]}):g.jsxs(g.Fragment,{children:[g.jsx("div",{className:"md:hidden space-y-3",children:k.map(F=>g.jsxs("div",{className:"bg-slate-900 border border-slate-800 rounded-xl p-4 shadow-lg",children:[g.jsxs("div",{className:"flex items-start gap-3",children:[F.imageUrl?g.jsx("img",{src:F.imageUrl,alt:F.code,className:"w-12 h-12 object-cover rounded-lg bg-slate-950 border border-slate-700 shrink-0"}):g.jsx("div",{className:"w-12 h-12 rounded-lg bg-slate-950 border border-slate-800 flex items-center justify-center text-slate-600 shrink-0",children:g.jsx(E0,{className:"w-5 h-5"})}),g.jsxs("div",{className:"min-w-0 flex-1",children:[g.jsxs("div",{className:"flex items-center justify-between gap-2",children:[g.jsx("div",{className:"font-mono text-cyan-400 font-bold text-sm",children:F.code}),g.jsx(bf,{status:F.recognitionStatus})]}),g.jsx("div",{className:"font-bold text-slate-100 mt-1 truncate",children:F.title||"未命名點位"}),g.jsxs("div",{className:"text-xs text-slate-500 mt-1 truncate",children:[F.buildingName," · ",F.floorName]})]})]}),g.jsxs("div",{className:"mt-3 flex items-center justify-between gap-3",children:[g.jsx("span",{className:`px-2.5 py-1 rounded text-xs font-medium ${F.enabled?"bg-green-500/10 text-green-400 border border-green-500/20":"bg-slate-800 text-slate-400 border border-slate-700"}`,children:F.enabled?"已啟用":"未啟用"}),g.jsxs("button",{onClick:()=>Yn(F.bId,F.fId,F.id),className:"inline-flex items-center gap-2 px-3 py-2 text-blue-400 bg-blue-400/10 hover:bg-blue-400/20 rounded-lg transition-colors text-sm",children:[g.jsx(Nd,{className:"w-4 h-4"}),"編輯"]})]})]},F.id))}),g.jsx("div",{className:"hidden md:block bg-slate-900 border border-slate-800 rounded-xl shadow-xl overflow-hidden",children:g.jsx("div",{className:"overflow-x-auto",children:g.jsxs("table",{className:"w-full text-left text-sm text-slate-300 min-w-[900px]",children:[g.jsx("thead",{className:"bg-slate-950/80 border-b border-slate-800 text-slate-400 whitespace-nowrap",children:g.jsxs("tr",{children:[g.jsx("th",{className:"px-4 py-4 font-semibold w-24",children:"所在位置"}),g.jsx("th",{className:"px-4 py-4 font-semibold w-20",children:"縮圖"}),g.jsx("th",{className:"px-4 py-4 font-semibold w-28",children:"代號 & 類型"}),g.jsx("th",{className:"px-4 py-4 font-semibold",children:"標題 & 描述"}),g.jsx("th",{className:"px-4 py-4 font-semibold w-28",children:"啟用狀態"}),g.jsx("th",{className:"px-4 py-4 font-semibold w-36",children:"測試狀態"}),g.jsx("th",{className:"px-4 py-4 font-semibold w-24 text-right",children:"操作"})]})}),g.jsx("tbody",{className:"divide-y divide-slate-800",children:k.map(F=>{var Re;const W=F.isVerticalShaft?(Re=N.find(ve=>ve.id===F.bId))==null?void 0:Re.floors.filter(ve=>{var Ue;return(Ue=F.linkedFloorIds)==null?void 0:Ue.includes(ve.id)}).sort((ve,Ue)=>Gn(Ue.name)-Gn(ve.name)).map(ve=>ve.name).join(", "):F.floorName;return g.jsxs("tr",{className:`hover:bg-slate-800/50 transition-colors ${F.isVerticalShaft?"bg-purple-900/5":""}`,children:[g.jsxs("td",{className:"px-4 py-4 whitespace-nowrap",children:[g.jsx("div",{className:"text-xs font-bold text-slate-300",children:F.buildingName}),g.jsx("div",{className:`text-[10px] mt-0.5 ${F.isVerticalShaft?"text-purple-400 font-bold":"text-cyan-400"}`,children:W})]}),g.jsx("td",{className:"px-4 py-4",children:F.imageUrl?g.jsx("img",{src:F.imageUrl,alt:F.code,className:"w-10 h-10 object-cover rounded bg-slate-950 border border-slate-700"}):g.jsx("div",{className:"w-10 h-10 rounded bg-slate-950 border border-slate-800 flex items-center justify-center text-slate-600",children:g.jsx(E0,{className:"w-4 h-4"})})}),g.jsxs("td",{className:"px-4 py-4 whitespace-nowrap",children:[g.jsx("div",{className:"font-mono text-cyan-400 font-bold mb-1",children:F.code}),F.isVerticalShaft?g.jsxs("div",{className:"inline-flex items-center bg-purple-500/10 text-purple-400 border border-purple-500/20 px-1.5 py-0.5 rounded text-[10px]",children:[g.jsx(_s,{className:"w-3 h-3 mr-1"})," 垂直貫穿"]}):F.arrowDirection!=="none"&&g.jsxs("div",{className:"inline-flex items-center bg-yellow-500/10 text-yellow-400 border border-yellow-500/20 px-1.5 py-0.5 rounded text-[10px]",children:[g.jsx(dw,{direction:F.arrowDirection,className:"w-3 h-3 mr-1"})," 方向"]})]}),g.jsxs("td",{className:"px-4 py-4",children:[g.jsx("div",{className:"font-bold text-slate-200 mb-1 line-clamp-1 max-w-[200px]",children:F.title||"未命名"}),g.jsx("div",{className:"text-xs text-slate-500 line-clamp-1 max-w-[200px]",children:F.description||"無描述"})]}),g.jsx("td",{className:"px-4 py-4 whitespace-nowrap",children:F.enabled?g.jsx("span",{className:"px-2.5 py-1 bg-green-500/10 text-green-400 border border-green-500/20 rounded text-xs font-medium",children:"已啟用"}):g.jsx("span",{className:"px-2.5 py-1 bg-slate-800 text-slate-400 border border-slate-700 rounded text-xs font-medium",children:"已停用"})}),g.jsx("td",{className:"px-4 py-4 whitespace-nowrap",children:g.jsx(bf,{status:F.recognitionStatus})}),g.jsx("td",{className:"px-4 py-4 text-right",children:g.jsx("button",{onClick:()=>Yn(F.bId,F.fId,F.id),className:"p-2 text-blue-400 hover:bg-blue-400/10 rounded transition-colors",title:"前往此樓層編輯",children:g.jsx(Nd,{className:"w-4 h-4"})})})]},F.id)})})]})})})]})]})})},Qe=()=>g.jsx("div",{className:"flex-1 p-4 md:p-8 overflow-auto bg-slate-950",children:g.jsxs("div",{className:"max-w-3xl mx-auto space-y-6 md:space-y-8",children:[Ee(),g.jsxs("div",{children:[g.jsxs("div",{className:"flex items-center mb-2",children:[g.jsx("button",{className:"md:hidden mr-3 text-slate-400 hover:text-white shrink-0",onClick:()=>u(!0),children:g.jsx(co,{className:"w-6 h-6"})}),g.jsxs("h2",{className:"text-xl md:text-2xl font-bold text-slate-200 flex items-center",children:[g.jsx(T0,{className:"mr-2 md:mr-3 text-cyan-400"})," 系統設定"]})]}),g.jsx("p",{className:"text-slate-500 text-xs md:text-sm",children:"匯出目前 AR 導引資料，包含大樓、樓層、平面圖、點位、路徑與設定資料。"})]}),g.jsxs("div",{className:"bg-slate-900 border border-slate-800 rounded-xl p-4 md:p-6 shadow-lg",children:[g.jsxs("h3",{className:"text-base md:text-lg font-bold text-slate-300 mb-4 md:mb-6 flex items-center",children:[g.jsx(nw,{className:"w-5 h-5 mr-2 text-blue-400"})," 基礎環境參數"]}),g.jsxs("div",{className:"space-y-4 md:space-y-5",children:[g.jsxs("div",{children:[g.jsx("label",{className:"block text-xs md:text-sm font-medium text-slate-400 mb-1.5",children:"系統專案名稱"}),g.jsx("input",{type:"text",value:O.projectName,onChange:w=>T({...O,projectName:w.target.value}),className:"w-full bg-slate-950 border border-slate-700 rounded-lg px-3 py-2 text-sm text-slate-200 focus:outline-none focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500"})]}),g.jsxs("div",{className:"pt-2 border-t border-slate-800",children:[g.jsx("label",{className:"block text-xs md:text-sm font-medium text-slate-400 mb-1.5 mt-2",children:"防抖強度預設值 (Lerp Factor)"}),g.jsx("input",{type:"range",min:"5",max:"50",value:O.lerpFactor,onChange:w=>T({...O,lerpFactor:parseInt(w.target.value)}),className:"w-full accent-cyan-500"})]})]})]}),g.jsxs("div",{className:"bg-slate-900 border border-red-900/30 rounded-xl p-4 md:p-6 shadow-lg",children:[g.jsxs("h3",{className:"text-base md:text-lg font-bold text-red-400 mb-2 flex items-center",children:[g.jsx(M0,{className:"w-5 h-5 mr-2"})," 資料庫管理"]}),g.jsx("p",{className:"text-xs md:text-sm text-slate-500 mb-4 md:mb-6",children:"這些操作將會對目前的配置造成不可逆的影響，請謹慎操作。"}),g.jsxs("div",{className:"flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 bg-slate-950 rounded-lg border border-red-900/50 gap-4",children:[g.jsxs("div",{children:[g.jsx("div",{className:"font-bold text-slate-300 text-sm md:text-base",children:"清空所有系統資料"}),g.jsx("div",{className:"text-xs text-slate-500 mt-1",children:"刪除所有建築物、樓層平面圖與點位。"})]}),g.jsx("button",{onClick:()=>{v({isOpen:!0,title:"清空所有資料",message:"確定要清空所有資料嗎？此操作無法復原。",onConfirm:()=>cr()})},className:"bg-red-500/10 hover:bg-red-500/20 text-red-400 border border-red-500/30 font-bold px-4 py-2 rounded-lg text-sm whitespace-nowrap",children:"清空資料"})]})]})]})}),De=()=>g.jsx("div",{className:"flex-1 p-4 md:p-8 overflow-auto bg-slate-950",children:g.jsxs("div",{className:"max-w-4xl mx-auto space-y-6",children:[Ee(),g.jsxs("div",{children:[g.jsxs("div",{className:"flex items-center mb-2",children:[g.jsx("button",{className:"md:hidden mr-3 text-slate-400 hover:text-white shrink-0",onClick:()=>u(!0),children:g.jsx(co,{className:"w-6 h-6"})}),g.jsxs("h2",{className:"text-xl md:text-2xl font-bold text-slate-200 flex items-center",children:[g.jsx(Hl,{className:"mr-2 md:mr-3 text-cyan-400"})," 匯出JSON"]})]}),g.jsx("p",{className:"text-slate-500 text-xs md:text-sm",children:"匯出目前 AR 導引資料，包含大樓、樓層、平面圖、點位、路徑與設定資料。"})]}),g.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-4",children:[g.jsxs("div",{className:"bg-slate-900 border border-slate-800 rounded-xl p-5",children:[g.jsx("div",{className:"text-2xl font-bold text-cyan-400",children:N.length}),g.jsx("div",{className:"text-xs text-slate-400 mt-1",children:"大樓數量"})]}),g.jsxs("div",{className:"bg-slate-900 border border-slate-800 rounded-xl p-5",children:[g.jsx("div",{className:"text-2xl font-bold text-cyan-400",children:N.reduce((w,k)=>w+k.floors.length,0)}),g.jsx("div",{className:"text-xs text-slate-400 mt-1",children:"樓層數量"})]}),g.jsxs("div",{className:"bg-slate-900 border border-slate-800 rounded-xl p-5",children:[g.jsx("div",{className:"text-2xl font-bold text-cyan-400",children:N.reduce((w,k)=>w+k.floors.reduce((F,W)=>F+(W.markers||[]).length,0),0)}),g.jsx("div",{className:"text-xs text-slate-400 mt-1",children:"AR 點位數量"})]})]}),g.jsxs("div",{className:"bg-slate-900 border border-slate-800 rounded-xl p-5 md:p-6 shadow-lg",children:[g.jsxs("h3",{className:"text-base md:text-lg font-bold text-slate-200 mb-3 flex items-center",children:[g.jsx(M0,{className:"w-5 h-5 mr-2 text-cyan-400"})," JSON 配置檔"]}),g.jsxs("p",{className:"text-sm text-slate-400 mb-5",children:["按下按鈕後會下載一份目前專案的 ",g.jsx("span",{className:"text-cyan-300 font-mono",children:"AR JSON v7"}),"，可供後續系統串接、備份或移轉使用。"]}),g.jsxs("button",{onClick:j,className:"w-full sm:w-auto flex items-center justify-center space-x-2 bg-cyan-500 hover:bg-cyan-400 text-slate-950 font-bold py-3 px-6 rounded-xl transition-all shadow-[0_0_18px_rgba(6,182,212,0.28)]",children:[g.jsx(Hl,{className:"w-5 h-5"}),g.jsx("span",{children:"下載 JSON 配置"})]})]})]})});return t?g.jsx("div",{className:"flex h-[100dvh] w-full bg-slate-950 text-slate-200 font-sans overflow-hidden selection:bg-cyan-500/30 relative",children:g.jsx(F0,{buildings:N,systemConfig:O,onMenuClick:()=>{}})}):g.jsxs("div",{className:`${s?"flex min-h-[760px] w-full":"flex h-[100dvh] w-full"} bg-slate-950 text-slate-200 font-sans overflow-hidden selection:bg-cyan-500/30 relative`,children:[!s&&l&&g.jsx("div",{className:"fixed inset-0 bg-slate-950/80 backdrop-blur-sm z-40 md:hidden",onClick:()=>u(!1)}),!s&&g.jsxs("div",{className:`fixed inset-y-0 left-0 z-50 w-[82vw] max-w-xs md:w-64 bg-slate-900 border-r border-slate-800 flex flex-col justify-between shrink-0 transition-transform duration-300 shadow-2xl md:relative md:translate-x-0 ${l?"translate-x-0":"-translate-x-full"}`,children:[g.jsxs("div",{children:[g.jsxs("div",{className:"h-16 flex items-center px-6 border-b border-slate-800 bg-slate-950/50 justify-between md:justify-start",children:[g.jsxs("div",{className:"flex items-center",children:[g.jsx(ha,{className:"w-7 h-7 md:w-8 md:h-8 text-cyan-400 drop-shadow-[0_0_8px_rgba(6,182,212,0.8)]"}),g.jsx("span",{className:"ml-3 font-bold text-base md:text-lg tracking-wider text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500",children:"AR導引功能"})]}),g.jsx("button",{className:"md:hidden text-slate-400 hover:text-white",onClick:()=>u(!1),children:g.jsx(ys,{className:"w-6 h-6"})})]}),g.jsxs("nav",{className:"p-4 space-y-2",children:[g.jsx(Wl,{icon:g.jsx(w0,{}),label:"平面圖管理",active:r==="map",onClick:()=>_e("map")}),g.jsx(Wl,{icon:g.jsx(lo,{}),label:"點位列表",active:r==="list",onClick:()=>_e("list")}),g.jsx(Wl,{icon:g.jsx(T0,{}),label:"系統設定",active:r==="settings",onClick:()=>_e("settings")}),g.jsx(Wl,{icon:g.jsx(Hl,{}),label:"匯出JSON",active:r==="export",onClick:()=>_e("export")})]})]}),g.jsx("div",{className:"p-4 border-t border-slate-800 bg-slate-900/50",children:g.jsx("div",{className:"text-[11px] leading-relaxed text-slate-500",children:"管理平面圖、點位、系統參數，並匯出 AR 導引 JSON。"})})]}),r==="frontend"&&g.jsx(F0,{buildings:N,systemConfig:O,onMenuClick:()=>u(!0)}),r==="list"&&Ze(),r==="settings"&&Qe(),r==="export"&&De(),r==="map"&&g.jsxs("div",{className:"flex-1 flex flex-col relative overflow-hidden bg-slate-950 w-full",children:[g.jsxs("div",{className:"absolute top-3 left-2 right-2 md:top-4 md:left-4 md:right-auto z-40 flex items-center gap-2 bg-slate-900/90 backdrop-blur-md border border-slate-700 p-2 rounded-xl shadow-lg overflow-x-auto md:overflow-visible whitespace-nowrap",children:[!s&&g.jsx("button",{className:"md:hidden text-slate-400 hover:text-white mr-1",onClick:()=>u(!0),children:g.jsx(co,{className:"w-5 h-5"})}),g.jsxs("div",{className:"flex items-center",children:[g.jsx(ha,{className:"w-4 h-4 text-cyan-400 ml-1 mr-2"}),g.jsx("select",{className:"bg-transparent text-cyan-300 text-sm font-bold focus:outline-none max-w-[120px] md:max-w-[150px] truncate",value:P,onChange:w=>V(w.target.value),children:L.map(w=>g.jsx("option",{value:w.id,className:"bg-slate-900",children:w.name},w.id))}),g.jsx("button",{onClick:yi,className:"ml-1 px-1 text-cyan-400 hover:text-cyan-300 transition-colors",title:"新增專案",children:g.jsx(Gl,{className:"w-4 h-4"})}),g.jsx("button",{onClick:ci,className:"px-1 text-green-400 hover:text-green-300 transition-colors",title:"儲存專案",children:g.jsx(Jl,{className:"w-4 h-4"})})]}),g.jsx("div",{className:"w-px h-5 bg-slate-700 mx-1"}),g.jsxs("div",{className:"flex items-center",children:[g.jsx(ew,{className:"w-4 h-4 text-slate-500 ml-1 mr-2"}),g.jsx("select",{className:"bg-transparent text-slate-200 text-sm font-medium focus:outline-none max-w-[110px] md:max-w-[120px] truncate",value:H,onChange:w=>Q(w.target.value),children:N.map(w=>g.jsx("option",{value:w.id,className:"bg-slate-900",children:w.name},w.id))}),g.jsx("button",{onClick:$t,className:"ml-1 px-1 text-cyan-400 hover:text-cyan-300 transition-colors",children:g.jsx(Gl,{className:"w-4 h-4"})})]}),g.jsx("div",{className:"w-px h-5 bg-slate-700 mx-1"}),Ke&&g.jsxs("div",{className:"flex items-center",children:[g.jsx(iw,{className:"w-4 h-4 text-slate-500 mr-2"}),g.jsx("select",{className:"bg-transparent text-cyan-400 font-bold text-sm focus:outline-none max-w-[100px] truncate",value:re,onChange:w=>pe(w.target.value),children:Ke.floors.slice().sort((w,k)=>Gn(k.name)-Gn(w.name)).map(w=>g.jsx("option",{value:w.id,className:"bg-slate-900",children:w.name},w.id))}),g.jsx("button",{onClick:En,className:"ml-1 px-1 text-cyan-400 hover:text-cyan-300 transition-colors",children:g.jsx(Gl,{className:"w-4 h-4"})})]}),g.jsx("div",{className:"w-px h-5 bg-slate-700 mx-1 hidden md:block"}),g.jsxs("div",{className:"hidden md:flex items-center",title:"透視其他樓層",children:[g.jsx(tw,{className:"w-4 h-4 text-slate-500 mr-1"}),g.jsxs("select",{className:"bg-transparent text-slate-400 text-xs focus:outline-none max-w-[90px] truncate",value:X,onChange:w=>oe(w.target.value),children:[g.jsx("option",{value:"",className:"bg-slate-900",children:"-- 關閉透視 --"}),N.flatMap(w=>w.floors.filter(k=>k.id!==re).sort((k,F)=>Gn(F.name)-Gn(k.name)).map(k=>g.jsxs("option",{value:k.id,className:"bg-slate-900",children:[w.name,"-",k.name]},k.id)))]})]})]}),g.jsxs("div",{className:"absolute left-2 right-2 bottom-3 md:left-auto md:right-4 md:bottom-auto md:top-4 z-40 flex flex-row md:flex-col gap-2 overflow-x-auto md:overflow-visible bg-slate-950/60 md:bg-transparent backdrop-blur md:backdrop-blur-0 p-2 md:p-0 rounded-xl md:rounded-none border border-slate-800/70 md:border-0",children:[g.jsxs("button",{onClick:()=>{He!=null&&He.imageUrl&&(U(!Ht),ue(!1),Se(!1),q(!1),wt(!1),ot(null),ee(null),ce(null),Et(null),ae([]),Ae([]))},disabled:!(He!=null&&He.imageUrl),className:`flex shrink-0 items-center justify-center gap-2 h-10 px-3 rounded-xl transition-all shadow-lg font-bold text-xs ${Ht?"bg-blue-500 text-white shadow-[0_0_15px_rgba(59,130,246,0.6)]":"bg-slate-900/90 backdrop-blur border border-slate-700 text-blue-400 hover:bg-slate-800 disabled:opacity-40 disabled:cursor-not-allowed"}`,title:"路網分析測試",children:[Ht?g.jsx(ys,{className:"w-5 h-5"}):g.jsx(S0,{className:"w-5 h-5"}),g.jsx("span",{children:"路網測試"})]}),(He==null?void 0:He.imageUrl)&&g.jsxs(g.Fragment,{children:[g.jsx("div",{className:"hidden md:block w-6 h-px bg-slate-700 mx-auto my-0.5"}),g.jsx("button",{onClick:()=>{Se(!be),ue(!1),U(!1),q(!1),wt(!1),ot(null),ee(null),ce(null),Et(null)},className:`flex shrink-0 items-center justify-center w-10 h-10 rounded-xl transition-all shadow-lg ${be?"bg-green-500 text-white shadow-[0_0_15px_rgba(34,197,94,0.6)]":"bg-slate-900/90 backdrop-blur border border-slate-700 text-green-400 hover:bg-slate-800"}`,title:"指定跨樓層轉折點 (點擊節點切換)",children:be?g.jsx(ys,{className:"w-5 h-5"}):g.jsx(_s,{className:"w-5 h-5"})}),g.jsx("button",{onClick:()=>{ue(!Te),Se(!1),U(!1),q(!1),wt(!1),ot(null),ee(null),ce(null),Et(null)},className:`flex shrink-0 items-center justify-center w-10 h-10 rounded-xl transition-all shadow-lg ${Te?"bg-orange-500 text-white shadow-[0_0_15px_rgba(249,115,22,0.6)]":"bg-slate-900/90 backdrop-blur border border-slate-700 text-orange-400 hover:bg-slate-800"}`,title:"路徑建置 (一般轉折點與連線)",children:Te?g.jsx(ys,{className:"w-5 h-5"}):g.jsx(ow,{className:"w-5 h-5"})}),g.jsx("button",{onClick:()=>{wt(!It),Se(!1),U(!1),q(!1),ue(!1),qe([]),Et(null)},className:`flex shrink-0 items-center justify-center w-10 h-10 rounded-xl transition-all shadow-lg ${It?"bg-purple-500 text-white shadow-[0_0_15px_rgba(168,85,247,0.6)]":"bg-slate-900/90 backdrop-blur border border-slate-700 text-purple-400 hover:bg-slate-800"}`,title:"尺規量測",children:It?g.jsx(ys,{className:"w-5 h-5"}):g.jsx(lw,{className:"w-5 h-5"})}),g.jsx("button",{onClick:()=>{q(!Gt),Se(!1),U(!1),wt(!1),ue(!1),Et(null)},className:`flex shrink-0 items-center justify-center w-10 h-10 rounded-xl transition-all shadow-lg ${Gt?"bg-cyan-500 text-slate-950 shadow-[0_0_15px_rgba(6,182,212,0.6)]":"bg-slate-900/90 backdrop-blur border border-slate-700 text-cyan-400 hover:bg-slate-800"}`,title:"新增 AR 點位",children:Gt?g.jsx(ys,{className:"w-5 h-5"}):g.jsx(lo,{className:"w-5 h-5"})}),g.jsx("button",{onClick:()=>y({isOpen:!0,blX:me.blX,blY:me.blY,trX:me.trX,trY:me.trY}),className:"flex shrink-0 items-center justify-center w-10 h-10 bg-slate-900/90 backdrop-blur border border-slate-700 text-blue-400 hover:bg-slate-800 rounded-xl transition-all shadow-lg",title:"座標與比例尺設定",children:g.jsx(ha,{className:"w-5 h-5"})})]}),g.jsx("input",{type:"file",ref:xe,onChange:In,className:"hidden",accept:"image/*"}),g.jsx("button",{onClick:()=>xe.current.click(),className:"flex shrink-0 items-center justify-center w-10 h-10 bg-slate-900/90 backdrop-blur border border-slate-700 text-slate-300 hover:text-white hover:bg-slate-800 rounded-xl transition-all shadow-lg",title:"上傳底圖",children:g.jsx(A0,{className:"w-5 h-5"})})]}),g.jsxs("div",{ref:Ve,className:`flex-1 relative overflow-hidden bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-slate-900 to-slate-950 touch-none select-none ${Te?"cursor-crosshair":be?"cursor-pointer":Gt||It||Ht?"cursor-crosshair":St?"cursor-grabbing":"cursor-grab"}`,onPointerDown:Wn,onPointerMove:Di,onPointerUp:Xn,onPointerCancel:Xn,children:[He&&g.jsxs("div",{className:"absolute left-4 top-4 z-[80] rounded-full border border-cyan-400/30 bg-slate-950/85 px-4 py-2 text-xs font-bold text-white shadow-xl backdrop-blur-md pointer-events-none",children:[(Ke==null?void 0:Ke.name)||"目前場域"," / ",He.name||"未命名樓層"]}),g.jsxs("div",{ref:We,className:"absolute top-0 left-0 origin-top-left will-change-transform",style:{transform:`translate(${Ce.x}px, ${Ce.y}px) scale(${Ce.scale})`},children:[X&&(()=>{let w=null;if(N.forEach(Ue=>Ue.floors.forEach(ft=>{ft.id===X&&(w=ft)})),!w)return null;const k=Jr(w),F=Z!==0?(k.trX-k.blX)/Z:1,W=ne!==0?(k.trY-k.blY)/ne:1,Re=Z!==0?(k.blX-me.blX)/Z:0,ve=ne!==0?(me.trY-k.trY)/ne:0;return g.jsxs("div",{className:"absolute z-0 pointer-events-none",style:{left:`${Re*100}%`,top:`${ve*100}%`,width:`${F*100}%`,height:`${W*100}%`,opacity:.4},children:[w.imageUrl&&g.jsx("img",{src:w.imageUrl,className:"w-full h-full object-cover rounded-lg filter grayscale sepia",alt:"reference"}),w.markers.map(Ue=>g.jsx("div",{className:"absolute -translate-x-1/2 -translate-y-1/2 flex flex-col items-center",style:{left:`${Ue.x*100}%`,top:`${Ue.y*100}%`},children:g.jsx("div",{className:"w-6 h-6 rounded-full border-2 border-dashed border-cyan-400 bg-cyan-400/20 flex items-center justify-center shadow-[0_0_10px_rgba(34,211,238,0.5)]",children:g.jsx("span",{className:"text-[8px] text-cyan-200",style:{transform:`scale(${1/Math.max(.5,Ce.scale)})`},children:Ue.code})})},Ue.id))]})})(),(He==null?void 0:He.imageUrl)&&g.jsx("img",{id:"current-map-image",src:He.imageUrl,alt:"Floor Plan",onLoad:Le,className:`select-none pointer-events-none block max-w-none rounded-lg relative z-10 transition-opacity ${X?"opacity-70 mix-blend-screen":"opacity-100"}`}),g.jsxs("svg",{className:"absolute inset-0 w-full h-full z-20 pointer-events-none",style:{overflow:"visible"},children:[g.jsx("defs",{children:g.jsx("marker",{id:"arrowhead-test",markerWidth:"6",markerHeight:"4",refX:"5",refY:"2",orient:"auto",children:g.jsx("polygon",{points:"0 0, 6 2, 0 4",fill:"#3b82f6"})})}),Ge.map(w=>{const k=Pt.find(W=>W.id===w.start)||$.find(W=>W.id===w.start),F=Pt.find(W=>W.id===w.end)||$.find(W=>W.id===w.end);return k&&F?g.jsx("line",{x1:`${k.x*100}%`,y1:`${k.y*100}%`,x2:`${F.x*100}%`,y2:`${F.y*100}%`,stroke:"#f97316",strokeWidth:3/Math.max(.2,Ce.scale),strokeOpacity:"0.7"},w.id):null}),Te&&Fe&&gt&&(()=>{const w=Pt.find(k=>k.id===Fe)||$.find(k=>k.id===Fe);return w?g.jsx("line",{x1:`${w.x*100}%`,y1:`${w.y*100}%`,x2:`${gt.x*100}%`,y2:`${gt.y*100}%`,stroke:"#f97316",strokeWidth:3/Math.max(.2,Ce.scale),strokeDasharray:"6,6",opacity:"0.8",className:"animate-[dash_0.5s_linear_infinite]"}):null})(),Ht&&Me.length>0&&Me.map((w,k)=>{if(k===Me.length-1)return null;const F=Me[k+1],W=[];return w.fId===re&&F.fId===re?W.push(g.jsx("line",{x1:`${w.x*100}%`,y1:`${w.y*100}%`,x2:`${F.x*100}%`,y2:`${F.y*100}%`,stroke:"#3b82f6",strokeWidth:5/Math.max(.2,Ce.scale),strokeDasharray:"15, 10",markerEnd:"url(#arrowhead-test)",className:"animate-[dash_1s_linear_infinite] drop-shadow-[0_0_8px_rgba(59,130,246,0.8)]"},`testline_${k}`)):w.fId===re&&F.fId!==re?W.push(g.jsxs("g",{children:[g.jsxs("circle",{cx:`${w.x*100}%`,cy:`${w.y*100}%`,r:12/Math.max(.5,Ce.scale),fill:"none",stroke:"#ef4444",strokeWidth:3/Math.max(.5,Ce.scale),children:[g.jsx("animate",{attributeName:"r",from:12/Math.max(.5,Ce.scale),to:35/Math.max(.5,Ce.scale),dur:"1.5s",repeatCount:"indefinite"}),g.jsx("animate",{attributeName:"opacity",from:"1",to:"0",dur:"1.5s",repeatCount:"indefinite"})]}),g.jsx("circle",{cx:`${w.x*100}%`,cy:`${w.y*100}%`,r:6/Math.max(.5,Ce.scale),fill:"#ef4444"}),g.jsxs("text",{x:`${w.x*100}%`,y:`${w.y*100}%`,dy:"-20",fill:"#ef4444",fontSize:12/Math.max(.5,Ce.scale),textAnchor:"middle",fontWeight:"bold",children:["搭乘至 ",F.fName]})]},`leave_${k}`)):w.fId!==re&&F.fId===re&&W.push(g.jsxs("g",{children:[g.jsxs("circle",{cx:`${F.x*100}%`,cy:`${F.y*100}%`,r:12/Math.max(.5,Ce.scale),fill:"none",stroke:"#22c55e",strokeWidth:3/Math.max(.5,Ce.scale),children:[g.jsx("animate",{attributeName:"r",from:12/Math.max(.5,Ce.scale),to:35/Math.max(.5,Ce.scale),dur:"1.5s",repeatCount:"indefinite"}),g.jsx("animate",{attributeName:"opacity",from:"1",to:"0",dur:"1.5s",repeatCount:"indefinite"})]}),g.jsx("circle",{cx:`${F.x*100}%`,cy:`${F.y*100}%`,r:6/Math.max(.5,Ce.scale),fill:"#22c55e"}),g.jsxs("text",{x:`${F.x*100}%`,y:`${F.y*100}%`,dy:"-20",fill:"#22c55e",fontSize:12/Math.max(.5,Ce.scale),textAnchor:"middle",fontWeight:"bold",children:["來自 ",w.fName]})]},`enter_${k}`)),g.jsx(Af.Fragment,{children:W},`testfrag_${k}`)})]}),$.map(w=>{const k=he===w.id,F=Fe===w.id,W=w.isVerticalShaft&&w.sourceFloorId&&w.sourceFloorId!==re;let Re="bg-orange-500",ve="border-white",Ue="";return w.isVerticalShaft&&(Re="bg-green-500"),F?(Re="bg-white",ve=W?"border-green-500":"border-orange-500",Ue=W?"shadow-[0_0_10px_green]":"shadow-[0_0_10px_orange]"):k&&(ve="border-cyan-400 border-2",Ue="shadow-[0_0_10px_cyan]"),g.jsx("div",{className:`waypoint-pin absolute -translate-x-1/2 -translate-y-1/2 z-30 cursor-pointer ${k?"z-40":""}`,style:{left:`${w.x*100}%`,top:`${w.y*100}%`},onPointerDown:ft=>{ft.stopPropagation(),ft.button===0&&(Te?_i(w.id):be?(w.isVerticalShaft||ct(w,!0,!1),ee(null),ce(w.id)):!Ht&&!It&&!St&&!Gt&&(ee(null),ce(w.id),le(w.id),ft.target.setPointerCapture(ft.pointerId)))},onPointerUp:ft=>{ft.stopPropagation(),ft.target.releasePointerCapture(ft.pointerId)},onContextMenu:ft=>{ft.preventDefault(),Te?Xt(w.id):be?w.isVerticalShaft&&ct(w,!1,!1):!Ht&&!It&&!Gt&&(ee(null),ce(w.id))},children:g.jsx("div",{className:`rounded-full transition-all flex items-center justify-center ${Re} ${ve} ${Ue}`,style:{width:`${(F?14:10)/Math.max(.5,Ce.scale)}px`,height:`${(F?14:10)/Math.max(.5,Ce.scale)}px`,borderWidth:k?"2px":"1px"},children:w.isVerticalShaft&&g.jsx(_s,{className:F?"text-slate-800":"text-white",style:{width:`${6/Math.max(.5,Ce.scale)}px`,height:`${6/Math.max(.5,Ce.scale)}px`}})})},w.id)}),Ht&&E.map((w,k)=>w.fId!==re?null:g.jsx("div",{className:"absolute -translate-x-1/2 -translate-y-1/2 z-[35] pointer-events-none",style:{left:`${w.x*100}%`,top:`${w.y*100}%`},children:g.jsx("div",{className:"rounded-full bg-blue-500 border-2 border-white shadow-[0_0_10px_rgba(59,130,246,0.8)] flex items-center justify-center text-[8px] font-bold text-white",style:{width:`${16/Math.max(.5,Ce.scale)}px`,height:`${16/Math.max(.5,Ce.scale)}px`},children:k===0?"起":"終"})},`testpt_${k}`)),It&&At.length>0&&g.jsxs("div",{className:"absolute inset-0 z-40 pointer-events-none",children:[g.jsxs("svg",{className:"w-full h-full",style:{overflow:"visible"},children:[At.length===2&&g.jsx("line",{x1:`${At[0].x*100}%`,y1:`${At[0].y*100}%`,x2:`${At[1].x*100}%`,y2:`${At[1].y*100}%`,stroke:"#a855f7",strokeWidth:3/Math.max(.1,Ce.scale),strokeDasharray:"5,5"}),At.map((w,k)=>g.jsx("circle",{cx:`${w.x*100}%`,cy:`${w.y*100}%`,r:6/Math.max(.1,Ce.scale),fill:"#a855f7",stroke:"#fff",strokeWidth:2/Math.max(.1,Ce.scale)},k))]}),At.length===2&&g.jsxs("div",{className:"absolute bg-purple-900/90 text-white px-3 py-1 rounded-full text-xs font-bold border border-purple-400 shadow-xl whitespace-nowrap",style:{left:`${(At[0].x+At[1].x)*50}%`,top:`${(At[0].y+At[1].y)*50}%`,transform:`translate(-50%, -150%) scale(${1/Math.max(.5,Ce.scale)})`},children:[Math.hypot((At[1].x-At[0].x)*Z,(At[1].y-At[0].y)*ne).toFixed(1)," m"]})]}),Pt.map(w=>{const k=w.isVerticalShaft?Ke==null?void 0:Ke.floors.filter(F=>{var W;return(W=w.linkedFloorIds)==null?void 0:W.includes(F.id)}).sort((F,W)=>Gn(W.name)-Gn(F.name)).map(F=>F.name).join(", "):"";return g.jsxs("div",{className:`marker-pin absolute -translate-x-1/2 -translate-y-1/2 cursor-grab active:cursor-grabbing group z-50 ${J===w.id?"z-[60]":""} ${Fe===w.id?"scale-125":""}`,style:{left:`${w.x*100}%`,top:`${w.y*100}%`},onPointerDown:F=>{F.stopPropagation(),F.button===0&&(Te?_i(w.id):be?(w.isVerticalShaft||ct(w,!0,!0),ce(null),ee(w.id)):!Ht&&!Gt&&!It&&!St&&(ce(null),le(w.id),ee(w.id),F.target.setPointerCapture(F.pointerId)))},onPointerUp:F=>{F.stopPropagation(),F.target.releasePointerCapture(F.pointerId)},onContextMenu:F=>{F.preventDefault(),Te?Xt(w.id):be?w.isVerticalShaft&&ct(w,!1,!0):!Ht&&!It&&!Gt&&(ce(null),ee(w.id))},children:[g.jsxs("div",{className:"relative pointer-events-none",children:[g.jsx("div",{className:`w-7 h-7 md:w-8 md:h-8 rounded-full flex items-center justify-center border-2 transition-all shadow-lg ${J===w.id?"bg-cyan-500 border-white text-slate-950 scale-110 shadow-[0_0_15px_rgba(6,182,212,0.8)]":w.enabled?w.isVerticalShaft?"bg-purple-600 border-purple-400 text-white":"bg-slate-800 border-cyan-500/50 text-slate-300 group-hover:border-cyan-400 group-hover:text-cyan-400":"bg-slate-900 border-slate-700 text-slate-600 opacity-70"} ${Fe===w.id?"border-orange-500 shadow-[0_0_15px_orange]":""}`,children:w.isVerticalShaft?g.jsx(_s,{className:"w-3.5 h-3.5",style:{transform:`scale(${1/Math.max(.5,Ce.scale)})`}}):g.jsx("span",{className:"text-[10px] md:text-xs font-bold",style:{transform:`scale(${1/Math.max(.5,Ce.scale)})`},children:w.code})}),g.jsx("div",{className:`absolute -bottom-1.5 md:-bottom-2 left-1/2 -translate-x-1/2 w-0 h-0 border-l-[5px] border-r-[5px] border-t-[6px] md:border-l-[6px] md:border-r-[6px] md:border-t-[8px] border-l-transparent border-r-transparent transition-all ${J===w.id?"border-t-white":w.enabled?w.isVerticalShaft?"border-t-purple-400":"border-t-cyan-500/50 group-hover:border-t-cyan-400":"border-t-slate-700 opacity-70"} ${Fe===w.id?"border-t-orange-500":""}`})]}),g.jsxs("div",{className:`absolute top-full left-1/2 -translate-x-1/2 mt-2 md:mt-3 whitespace-nowrap px-1.5 py-0.5 md:px-2 md:py-1 bg-slate-900 border text-[10px] md:text-xs rounded opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity shadow-lg ${J===w.id?"opacity-100 border-cyan-500 text-cyan-400":w.enabled?"border-slate-700 text-slate-300":"border-slate-800 text-slate-500"}`,style:{transform:`scale(${1/Math.max(.5,Ce.scale)})`,transformOrigin:"top center"},children:[w.title||"未命名"," ",w.isVerticalShaft&&g.jsxs("span",{className:"text-purple-400 block mt-0.5",children:["(貫通: ",k,")"]})]})]},w.id)})]}),be&&g.jsxs("div",{className:"absolute bottom-16 left-1/2 -translate-x-1/2 bg-green-500/95 text-white px-5 py-3 rounded-2xl text-xs font-bold shadow-[0_0_20px_rgba(34,197,94,0.5)] flex items-center pointer-events-auto z-50",children:[g.jsx(_s,{className:"w-5 h-5 mr-3 shrink-0"}),g.jsxs("div",{className:"flex flex-col",children:[g.jsx("span",{children:"點擊既有節點指定為「跨樓層轉折點」，右鍵取消。"}),g.jsx("span",{className:"text-green-200 font-normal",children:"指定後將自動開啟右側面板，請勾選要連通的樓層。"})]})]}),Te&&g.jsxs("div",{className:"absolute bottom-16 left-1/2 -translate-x-1/2 bg-orange-500/95 text-white px-5 py-3 rounded-2xl text-xs font-bold shadow-[0_0_20px_rgba(249,115,22,0.5)] flex items-center pointer-events-auto z-50",children:[g.jsx(sw,{className:"w-5 h-5 mr-3 shrink-0"}),g.jsxs("div",{className:"flex flex-col",children:[g.jsx("span",{children:"點擊空處建立轉折點與連線路網 (AR 標籤不須強迫連線)。"}),g.jsx("span",{className:"text-orange-200 font-normal",children:"點擊「目前發光點」或按 ESC 中斷畫線。右鍵刪除節點。"})]})]}),Ht&&g.jsxs("div",{className:"absolute bottom-16 left-1/2 -translate-x-1/2 bg-blue-500/95 text-white px-5 py-3 rounded-2xl text-xs font-bold shadow-[0_0_20px_rgba(59,130,246,0.5)] flex items-center pointer-events-auto z-50",children:[g.jsx(S0,{className:"w-5 h-5 mr-3 shrink-0 animate-pulse"}),g.jsxs("div",{className:"flex flex-col",children:[g.jsx("span",{children:"路網分析測試模式：已啟用自動吸附演算"}),g.jsx("span",{className:"text-blue-200 font-normal",children:"請在地圖上任意點擊兩處，系統將模擬導航並畫出藍色最佳路徑。"})]})]}),!(He!=null&&He.imageUrl)&&g.jsxs("div",{className:"absolute inset-0 flex flex-col items-center justify-center text-center text-slate-500 pointer-events-none px-4",children:[g.jsx(w0,{className:"w-12 h-12 mx-auto mb-3 opacity-50 text-cyan-500/30"}),g.jsxs("p",{className:"text-base md:text-lg mb-1",children:["尚未載入 ",Ke==null?void 0:Ke.name," - ",He==null?void 0:He.name," 的平面圖"]}),g.jsx("p",{className:"text-xs",children:"點擊右側工具列「上傳底圖」"})]}),(He==null?void 0:He.imageUrl)&&G>0&&g.jsxs("div",{onClick:()=>y({isOpen:!0,blX:me.blX,blY:me.blY,trX:me.trX,trY:me.trY}),className:"absolute top-20 right-3 md:top-4 md:right-20 z-40 bg-slate-900/80 backdrop-blur-sm border border-slate-700 p-2.5 rounded-lg shadow-lg cursor-pointer hover:bg-slate-800 transition-colors",title:"點擊校正全域座標",children:[g.jsxs("span",{className:"text-[10px] text-cyan-400 font-bold mb-1.5 flex items-center",children:[g.jsx(ha,{className:"w-3 h-3 mr-1"})," 比例尺: ",b," m"]}),g.jsx("div",{className:"h-1.5 bg-cyan-500/50 border-x-2 border-cyan-400",style:{width:`${G}px`}})]}),(He==null?void 0:He.imageUrl)&&g.jsxs("div",{className:"absolute bottom-28 right-3 md:bottom-4 md:right-4 flex flex-col space-y-2 z-40",children:[g.jsx("button",{onClick:()=>tt(w=>({...w,scale:Math.min(10,w.scale*1.2)})),className:"p-2 bg-slate-900/90 backdrop-blur border border-slate-700 hover:bg-slate-800 text-slate-200 rounded-xl shadow-lg transition-colors",children:g.jsx(Cg,{className:"w-5 h-5"})}),g.jsx("button",{onClick:()=>tt(w=>({...w,scale:Math.max(.1,w.scale/1.2)})),className:"p-2 bg-slate-900/90 backdrop-blur border border-slate-700 hover:bg-slate-800 text-slate-200 rounded-xl shadow-lg transition-colors",children:g.jsx(Rg,{className:"w-5 h-5"})}),g.jsx("button",{onClick:Le,className:"p-2 bg-slate-900/90 backdrop-blur border border-slate-700 hover:bg-slate-800 text-slate-200 rounded-xl shadow-lg transition-colors mt-1",children:g.jsx(rw,{className:"w-5 h-5"})})]})]})]}),D.isOpen&&g.jsx("div",{className:"fixed inset-0 bg-slate-950/80 backdrop-blur-sm z-[100] flex items-center justify-center p-4",children:g.jsxs("div",{className:"bg-slate-900 border border-blue-900/50 rounded-xl w-full max-w-md p-6",children:[g.jsxs("h3",{className:"text-lg font-bold text-blue-400 mb-4 flex items-center",children:[g.jsx(ha,{className:"w-5 h-5 mr-2"})," 樓層實體座標與比例尺設定"]}),g.jsxs("p",{className:"text-slate-400 text-xs mb-4 leading-relaxed",children:["設定此樓層對應的真實物理座標 (公尺)。",g.jsx("br",{}),"修改差值即等同設定這張圖片在真實空間的總寬度與總長度。"]}),g.jsxs("div",{className:"grid grid-cols-2 gap-4 mb-6",children:[g.jsxs("div",{className:"space-y-3 p-3 bg-slate-950 rounded border border-slate-800",children:[g.jsx("h4",{className:"text-xs font-bold text-slate-300",children:"↙️ 左下角 (Bottom-Left)"}),g.jsxs("div",{children:[g.jsx("label",{className:"text-[10px] text-slate-500",children:"X 座標 (m)"}),g.jsx("input",{type:"number",value:D.blX,onChange:w=>y({...D,blX:parseFloat(w.target.value)||0}),className:"w-full bg-slate-900 border border-slate-700 rounded px-2 py-1.5 text-sm text-slate-200 mt-1"})]}),g.jsxs("div",{children:[g.jsx("label",{className:"text-[10px] text-slate-500",children:"Y 座標 (m)"}),g.jsx("input",{type:"number",value:D.blY,onChange:w=>y({...D,blY:parseFloat(w.target.value)||0}),className:"w-full bg-slate-900 border border-slate-700 rounded px-2 py-1.5 text-sm text-slate-200 mt-1"})]})]}),g.jsxs("div",{className:"space-y-3 p-3 bg-slate-950 rounded border border-slate-800",children:[g.jsx("h4",{className:"text-xs font-bold text-slate-300",children:"↗️ 右上角 (Top-Right)"}),g.jsxs("div",{children:[g.jsx("label",{className:"text-[10px] text-slate-500",children:"X 座標 (m)"}),g.jsx("input",{type:"number",value:D.trX,onChange:w=>y({...D,trX:parseFloat(w.target.value)||0}),className:"w-full bg-slate-900 border border-slate-700 rounded px-2 py-1.5 text-sm text-slate-200 mt-1"})]}),g.jsxs("div",{children:[g.jsx("label",{className:"text-[10px] text-slate-500",children:"Y 座標 (m)"}),g.jsx("input",{type:"number",value:D.trY,onChange:w=>y({...D,trY:parseFloat(w.target.value)||0}),className:"w-full bg-slate-900 border border-slate-700 rounded px-2 py-1.5 text-sm text-slate-200 mt-1"})]})]})]}),g.jsx("button",{onClick:()=>{Y(w=>w.map(k=>k.id===H?{...k,floors:k.floors.map(F=>F.id===re?{...F,bounds:{blX:D.blX,blY:D.blY,trX:D.trX,trY:D.trY}}:F)}:k)),y({isOpen:!1}),x({isOpen:!0,message:"樓層座標已更新！"})},className:"w-full py-3 bg-blue-500 text-white font-bold rounded-lg shadow-lg",children:"儲存套用"})]})}),f.isOpen&&g.jsx("div",{className:"fixed inset-0 bg-slate-950/80 backdrop-blur-sm z-[100] flex items-center justify-center p-4",children:g.jsxs("div",{className:"bg-slate-900 border border-slate-700 rounded-xl w-full max-w-sm p-6 shadow-2xl",children:[g.jsx("h3",{className:"text-lg font-bold text-white mb-4",children:f.title}),g.jsx("input",{autoFocus:!0,type:"text",placeholder:f.placeholder,defaultValue:f.defaultValue,className:"w-full bg-slate-950 border border-slate-700 rounded-lg px-4 py-3 text-slate-200 focus:outline-none focus:border-cyan-500 mb-6",onKeyDown:w=>{w.key==="Enter"&&(f.onSubmit(w.target.value),h({isOpen:!1}))}}),g.jsxs("div",{className:"flex space-x-3 justify-end",children:[g.jsx("button",{onClick:()=>h({isOpen:!1}),className:"px-5 py-2 bg-slate-800 text-slate-300 rounded-lg",children:"取消"}),g.jsx("button",{onClick:w=>{f.onSubmit(w.target.parentElement.previousElementSibling.value),h({isOpen:!1})},className:"px-5 py-2 bg-cyan-500 text-slate-950 font-bold rounded-lg",children:"確定"})]})]})}),p.isOpen&&g.jsx("div",{className:"fixed inset-0 bg-slate-950/80 backdrop-blur-sm z-[100] flex items-center justify-center p-4",children:g.jsxs("div",{className:"bg-slate-900 border border-red-900/50 rounded-xl w-full max-w-sm p-6 shadow-2xl",children:[g.jsx("h3",{className:"text-lg font-bold text-red-400 mb-2",children:p.title}),g.jsx("p",{className:"text-slate-300 text-sm mb-6",children:p.message}),g.jsxs("div",{className:"flex space-x-3 justify-end",children:[g.jsx("button",{onClick:()=>v({isOpen:!1}),className:"px-5 py-2 bg-slate-800 text-slate-300 rounded-lg",children:"取消"}),g.jsx("button",{onClick:()=>{p.onConfirm(),v({isOpen:!1})},className:"px-5 py-2 bg-red-500 text-white font-bold rounded-lg",children:"確定執行"})]})]})}),S.isOpen&&g.jsx("div",{className:"fixed inset-0 bg-slate-950/80 backdrop-blur-sm z-[100] flex items-center justify-center p-4",children:g.jsxs("div",{className:"bg-slate-900 border border-yellow-500/50 rounded-xl w-full max-w-sm p-6 shadow-2xl text-center",children:[g.jsx(Ag,{className:"w-16 h-16 text-yellow-500 mx-auto mb-4"}),g.jsx("h3",{className:"text-lg font-bold text-white mb-2",children:"系統提示"}),g.jsx("p",{className:"text-slate-300 text-sm mb-6",children:S.message}),g.jsx("button",{onClick:()=>x({isOpen:!1}),className:"w-full px-5 py-3 bg-cyan-500 text-slate-950 font-bold rounded-lg",children:"我知道了"})]})}),M&&g.jsx("div",{className:"fixed inset-0 bg-slate-950/90 backdrop-blur-md z-[200] flex items-center justify-center p-4",children:g.jsxs("div",{className:"bg-slate-900 border border-cyan-500/30 rounded-2xl w-full max-w-md p-8 shadow-2xl text-center",children:[g.jsxs("div",{className:"flex justify-center space-x-4 mb-6",children:[g.jsx("div",{className:"bg-cyan-500/20 p-4 rounded-full border border-cyan-500/30",children:g.jsx(wf,{className:"w-10 h-10 text-cyan-400"})}),g.jsx("div",{className:"bg-purple-500/20 p-4 rounded-full border border-purple-500/30",children:g.jsx(uw,{className:"w-10 h-10 text-purple-400"})})]}),g.jsx("h3",{className:"text-2xl font-bold text-white mb-3",children:"歡迎使用 AR 導覽"}),g.jsxs("p",{className:"text-slate-400 text-sm leading-relaxed mb-8",children:["為了提供最佳的空間定位體驗，本系統需要使用您的",g.jsx("b",{children:"「相機」"}),"進行掃描，以及",g.jsx("b",{children:"「陀螺儀」"}),"來偵測手機方位。請在下一步允許存取。"]}),g.jsxs("button",{onClick:Oe,className:"w-full px-6 py-4 bg-cyan-500 text-slate-950 font-bold rounded-xl text-lg flex items-center justify-center shadow-[0_0_20px_rgba(6,182,212,0.4)]",children:[g.jsx(Jl,{className:"w-5 h-5 mr-2"})," 允許權限並開始"]})]})}),g.jsxs("div",{className:`fixed inset-x-0 bottom-0 z-50 max-h-[86dvh] rounded-t-2xl border-t border-slate-800 bg-slate-900 shadow-2xl md:inset-x-auto md:inset-y-0 md:right-0 md:max-h-none md:w-80 md:rounded-none md:border-t-0 md:border-l lg:w-96 flex flex-col shrink-0 transition-transform duration-300 ${r==="map"&&(J||he)?"translate-y-0 md:translate-x-0":"translate-y-full md:translate-y-0 md:translate-x-full absolute invisible"}`,children:[g.jsxs("div",{className:"h-16 flex items-center justify-between px-4 border-b border-slate-800 bg-slate-950/80 backdrop-blur shrink-0",children:[g.jsx("h2",{className:"font-bold text-slate-200",children:J?"AR 點位設定":"轉折點 (Waypoint) 設定"}),g.jsx("button",{onClick:()=>{ee(null),ce(null)},className:"text-slate-400 hover:text-white p-2",children:g.jsx(ys,{})})]}),Ne&&g.jsxs(g.Fragment,{children:[g.jsxs("div",{className:"flex-1 overflow-y-auto p-4 space-y-5 pb-8",children:[g.jsxs("div",{className:"space-y-3",children:[g.jsxs("div",{className:"flex space-x-3",children:[g.jsxs("div",{className:"flex-1",children:[g.jsx("label",{className:"block text-[11px] text-slate-400 mb-1",children:"代號"}),g.jsx("input",{type:"text",value:Ne.code,onChange:w=>ke(Ne.id,"code",w.target.value),className:"w-full bg-slate-950 border border-slate-800 rounded px-3 py-2 text-sm text-slate-200"})]}),g.jsxs("div",{className:"flex-[2]",children:[g.jsx("label",{className:"block text-[11px] text-slate-400 mb-1",children:"標題"}),g.jsx("input",{type:"text",value:Ne.title,onChange:w=>ke(Ne.id,"title",w.target.value),className:"w-full bg-slate-950 border border-slate-800 rounded px-3 py-2 text-sm text-slate-200"})]})]}),g.jsxs("div",{children:[g.jsx("label",{className:"block text-[11px] text-slate-400 mb-1",children:"描述說明"}),g.jsx("textarea",{value:Ne.description||"",onChange:w=>ke(Ne.id,"description",w.target.value),rows:2,className:"w-full bg-slate-950 border border-slate-800 rounded px-3 py-2 text-sm text-slate-200 resize-none"})]}),g.jsxs("div",{className:"flex space-x-3",children:[g.jsxs("div",{className:"flex-1",children:[g.jsx("label",{className:"block text-[11px] text-slate-400 mb-1",children:"相對 X (%)"}),g.jsx("input",{type:"number",step:"0.1",value:+(Ne.x*100).toFixed(1),onChange:w=>ke(Ne.id,"x",Math.max(0,Math.min(100,parseFloat(w.target.value)||0))/100),className:"w-full bg-slate-950 border border-slate-800 rounded px-3 py-2 text-sm text-slate-200"})]}),g.jsxs("div",{className:"flex-1",children:[g.jsx("label",{className:"block text-[11px] text-slate-400 mb-1",children:"相對 Y (%)"}),g.jsx("input",{type:"number",step:"0.1",value:+(Ne.y*100).toFixed(1),onChange:w=>ke(Ne.id,"y",Math.max(0,Math.min(100,parseFloat(w.target.value)||0))/100),className:"w-full bg-slate-950 border border-slate-800 rounded px-3 py-2 text-sm text-slate-200"})]})]}),g.jsxs("div",{className:"p-3 bg-slate-950/50 border border-slate-800 rounded-xl space-y-3",children:[g.jsxs("div",{className:"flex items-center justify-between",children:[g.jsxs("label",{className:"text-xs font-medium text-purple-400 cursor-pointer flex items-center",htmlFor:"toggle-shaft-m",children:[g.jsx(_s,{className:"w-4 h-4 mr-1.5"})," 設為垂直貫通節點"]}),g.jsxs("label",{className:"relative inline-flex items-center cursor-pointer",children:[g.jsx("input",{type:"checkbox",id:"toggle-shaft-m",checked:Ne.isVerticalShaft||!1,onChange:w=>ct(Ne,w.target.checked,!0),className:"sr-only peer"}),g.jsx("div",{className:"w-8 h-4 bg-slate-800 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-slate-400 after:border-slate-300 after:border after:rounded-full after:h-3 after:w-3 after:transition-all peer-checked:bg-purple-500 peer-checked:after:bg-white shadow-inner"})]})]}),Ne.isVerticalShaft?g.jsx("div",{className:"pt-2 border-t border-slate-800/50",children:g.jsx("div",{className:"grid grid-cols-2 gap-2 mt-2",children:Ke==null?void 0:Ke.floors.slice().sort((w,k)=>Gn(k.name)-Gn(w.name)).map(w=>{var W;const k=(W=Ne.linkedFloorIds)==null?void 0:W.includes(w.id),F=w.id===re;return g.jsxs("label",{className:`flex items-center p-2 rounded-lg border transition-colors ${k?"bg-purple-500/20 border-purple-500/50 text-purple-300":"bg-slate-900 border-slate-800 text-slate-500 hover:border-slate-700 cursor-pointer"}`,children:[g.jsx("input",{type:"checkbox",className:"mr-2 accent-purple-500 rounded",disabled:F,checked:k||F,onChange:Re=>Mt(Ne,w.id,Re.target.checked,!0)}),g.jsxs("span",{className:"text-xs font-bold",children:[w.name," ",F&&"(目前)"]})]},w.id)})})}):g.jsxs("div",{className:"pt-2 border-t border-slate-800/50",children:[g.jsx("label",{className:"block text-[11px] text-slate-400 mb-1",children:"強制導引方向 (一般節點用)"}),g.jsxs("select",{value:Ne.arrowDirection||"none",onChange:w=>ke(Ne.id,"arrowDirection",w.target.value),className:"w-full bg-slate-950 border border-slate-800 rounded px-3 py-2 text-xs text-slate-200 focus:border-cyan-500",children:[g.jsx("option",{value:"none",children:"無/自動計算方向 (Auto)"}),g.jsx("option",{value:"up",children:"上 (Up)"}),g.jsx("option",{value:"down",children:"下 (Down)"}),g.jsx("option",{value:"left",children:"左 (Left)"}),g.jsx("option",{value:"right",children:"右 (Right)"})]})]})]}),g.jsxs("div",{className:"flex items-center justify-between pt-1",children:[g.jsx("label",{className:"text-xs font-medium text-slate-300 cursor-pointer",htmlFor:"toggle-enable-m",children:"啟用此點位辨識"}),g.jsxs("label",{className:"relative inline-flex items-center cursor-pointer",children:[g.jsx("input",{type:"checkbox",id:"toggle-enable-m",checked:Ne.enabled,onChange:w=>ke(Ne.id,"enabled",w.target.checked),className:"sr-only peer"}),g.jsx("div",{className:"w-9 h-5 bg-slate-800 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-slate-400 after:border-slate-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-cyan-500 peer-checked:after:bg-white shadow-inner"})]})]})]}),g.jsx("hr",{className:"border-slate-800"}),g.jsxs("div",{className:"space-y-3",children:[g.jsxs("div",{className:"flex items-center justify-between",children:[g.jsx("h3",{className:"text-xs font-semibold text-cyan-400",children:"Target Image 辨識圖"}),g.jsx("input",{type:"file",ref:we,onChange:gn,className:"hidden",accept:"image/*"}),g.jsx("button",{onClick:()=>we.current.click(),className:"text-[10px] text-slate-300 bg-slate-800 hover:bg-slate-700 px-3 py-1.5 rounded transition-colors border border-slate-700",children:"上傳/更換"})]}),g.jsx("div",{className:"border border-slate-800 bg-slate-950 rounded-xl p-2 flex items-center justify-center min-h-[140px]",children:Ne.imageUrl?g.jsx("img",{src:Ne.imageUrl,alt:"Target",className:"max-w-full max-h-40 object-contain rounded"}):g.jsxs("div",{className:"text-center text-slate-600",children:[g.jsx(wf,{className:"w-8 h-8 mx-auto mb-2 opacity-50"}),g.jsx("span",{className:"text-xs",children:"未上傳辨識圖"})]})})]}),g.jsx(Sw,{marker:Ne,onUpdateStatus:w=>ke(Ne.id,"recognitionStatus",w),showAlert:w=>x({isOpen:!0,message:w})})]}),g.jsx("div",{className:"p-4 border-t border-slate-800 bg-slate-900 shrink-0 pb-safe",children:et?g.jsxs("div",{className:"flex space-x-2 animate-in fade-in slide-in-from-bottom-2",children:[g.jsx("button",{onClick:()=>st(!1),className:"flex-1 bg-slate-800 hover:bg-slate-700 text-slate-300 font-bold py-2.5 rounded-xl border border-slate-700 text-sm",children:"取消"}),g.jsx("button",{onClick:()=>Xt(Ne.id),className:"flex-1 bg-red-500 hover:bg-red-400 text-white font-bold py-2.5 rounded-xl shadow-[0_0_10px_rgba(239,68,68,0.4)] text-sm",children:"確定刪除"})]}):g.jsxs("div",{className:"flex space-x-3",children:[g.jsx("button",{onClick:()=>st(!0),className:"flex items-center justify-center p-3 text-red-400 bg-red-400/10 hover:bg-red-400/20 rounded-xl border border-red-500/20",children:g.jsx(Pd,{className:"w-5 h-5"})}),g.jsx("button",{onClick:()=>ee(null),className:"flex-1 bg-cyan-500 hover:bg-cyan-400 text-slate-950 font-bold py-3 rounded-xl shadow-[0_0_15px_rgba(6,182,212,0.3)] text-sm",children:"完成設定"})]})})]}),nt&&g.jsxs(g.Fragment,{children:[g.jsx("div",{className:"flex-1 overflow-y-auto p-4 space-y-5 pb-8",children:g.jsxs("div",{className:"space-y-3",children:[g.jsxs("div",{className:"flex space-x-3",children:[g.jsxs("div",{className:"flex-1",children:[g.jsx("label",{className:"block text-[11px] text-slate-400 mb-1",children:"相對 X (%)"}),g.jsx("input",{type:"number",step:"0.1",value:+(nt.x*100).toFixed(1),onChange:w=>ye(nt.id,"x",Math.max(0,Math.min(100,parseFloat(w.target.value)||0))/100),className:"w-full bg-slate-950 border border-slate-800 rounded px-3 py-2 text-sm text-slate-200"})]}),g.jsxs("div",{className:"flex-1",children:[g.jsx("label",{className:"block text-[11px] text-slate-400 mb-1",children:"相對 Y (%)"}),g.jsx("input",{type:"number",step:"0.1",value:+(nt.y*100).toFixed(1),onChange:w=>ye(nt.id,"y",Math.max(0,Math.min(100,parseFloat(w.target.value)||0))/100),className:"w-full bg-slate-950 border border-slate-800 rounded px-3 py-2 text-sm text-slate-200"})]})]}),g.jsxs("div",{className:"p-3 bg-slate-950/50 border border-slate-800 rounded-xl space-y-3 mt-4",children:[g.jsxs("div",{className:"flex items-center justify-between",children:[g.jsxs("label",{className:"text-xs font-medium text-green-400 cursor-pointer flex items-center",htmlFor:"toggle-shaft-wp",children:[g.jsx(_s,{className:"w-4 h-4 mr-1.5"})," 設為垂直貫通轉折點"]}),g.jsxs("label",{className:"relative inline-flex items-center cursor-pointer",children:[g.jsx("input",{type:"checkbox",id:"toggle-shaft-wp",checked:nt.isVerticalShaft||!1,onChange:w=>ct(nt,w.target.checked,!1),className:"sr-only peer"}),g.jsx("div",{className:"w-8 h-4 bg-slate-800 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-slate-400 after:border-slate-300 after:border after:rounded-full after:h-3 after:w-3 after:transition-all peer-checked:bg-green-500 peer-checked:after:bg-white shadow-inner"})]})]}),nt.isVerticalShaft&&g.jsxs("div",{className:"pt-2 border-t border-slate-800/50",children:[g.jsx("p",{className:"text-[10px] text-slate-400 mb-2 leading-relaxed",children:"勾選後，此點位將會以綠色顯示於其他樓層，您可以在該樓層直接將其與路網連線，系統將自動支援跨樓層導航。"}),g.jsx("div",{className:"grid grid-cols-2 gap-2 mt-2",children:Ke==null?void 0:Ke.floors.slice().sort((w,k)=>Gn(k.name)-Gn(w.name)).map(w=>{var W;const k=(W=nt.linkedFloorIds)==null?void 0:W.includes(w.id),F=w.id===re;return g.jsxs("label",{className:`flex items-center p-2 rounded-lg border transition-colors ${k?"bg-green-500/20 border-green-500/50 text-green-300":"bg-slate-900 border-slate-800 text-slate-500 hover:border-slate-700 cursor-pointer"}`,children:[g.jsx("input",{type:"checkbox",className:"mr-2 accent-green-500 rounded",disabled:F,checked:k||F,onChange:Re=>Mt(nt,w.id,Re.target.checked,!1)}),g.jsxs("span",{className:"text-xs font-bold",children:[w.name," ",F&&"(目前)"]})]},w.id)})})]})]})]})}),g.jsx("div",{className:"p-4 border-t border-slate-800 bg-slate-900 shrink-0 pb-safe",children:et?g.jsxs("div",{className:"flex space-x-2 animate-in fade-in slide-in-from-bottom-2",children:[g.jsx("button",{onClick:()=>st(!1),className:"flex-1 bg-slate-800 hover:bg-slate-700 text-slate-300 font-bold py-2.5 rounded-xl border border-slate-700 text-sm",children:"取消"}),g.jsx("button",{onClick:()=>Xt(nt.id),className:"flex-1 bg-red-500 hover:bg-red-400 text-white font-bold py-2.5 rounded-xl shadow-[0_0_10px_rgba(239,68,68,0.4)] text-sm",children:"確定刪除"})]}):g.jsxs("div",{className:"flex space-x-3",children:[g.jsx("button",{onClick:()=>st(!0),className:"flex items-center justify-center p-3 text-red-400 bg-red-400/10 hover:bg-red-400/20 rounded-xl border border-red-500/20",children:g.jsx(Pd,{className:"w-5 h-5"})}),g.jsx("button",{onClick:()=>ce(null),className:"flex-1 bg-orange-500 hover:bg-orange-400 text-white font-bold py-3 rounded-xl shadow-[0_0_15px_rgba(249,115,22,0.3)] text-sm",children:"完成設定"})]})})]})]})]})}function Wl({icon:s,label:e,active:t,onClick:r}){return g.jsxs("div",{onClick:r,className:`flex items-center p-3 rounded-xl cursor-pointer transition-all ${t?"bg-cyan-500/10 text-cyan-400 font-bold shadow-inner":"text-slate-400 hover:bg-slate-800 hover:text-slate-200"}`,children:[g.jsx("div",{className:`w-5 h-5 shrink-0 ${t?"scale-110":""}`,children:s}),g.jsx("span",{className:"ml-3 text-sm md:text-base flex-1",children:e})]})}function bf({status:s}){const e={untested:{color:"text-slate-400",border:"border-slate-700",bg:"bg-slate-800/50",text:"尚未測試",icon:null},testing:{color:"text-yellow-400",border:"border-yellow-500/50",bg:"bg-yellow-500/10",text:"測試中...",icon:g.jsx("span",{className:"animate-spin mr-1 w-3 h-3 border-2 border-yellow-400 border-t-transparent rounded-full inline-block"})},success:{color:"text-green-400",border:"border-green-500/50",bg:"bg-green-500/10",text:"高辨識度",icon:g.jsx(Jl,{className:"w-3 h-3 mr-1 inline"})},unstable:{color:"text-orange-400",border:"border-orange-500/50",bg:"bg-orange-500/10",text:"不穩定",icon:g.jsx(Ag,{className:"w-3 h-3 mr-1 inline"})}},t=e[s]||e.untested;return g.jsxs("span",{className:`inline-flex items-center px-2 py-0.5 rounded text-[10px] font-bold border ${t.bg} ${t.border} ${t.color}`,children:[t.icon," ",t.text]})}function Sw({marker:s,onUpdateStatus:e,showAlert:t}){const[r,o]=Pe.useState("idle"),[l,u]=Pe.useState({fps:0,matches:0,inliers:0,status:"OFFLINE"}),f=Pe.useRef(null),h=Pe.useRef(null),p=Pe.useRef(null),v=Pe.useRef(null),S=Pe.useRef(null),x=Pe.useRef({refGray:null,refKeypoints:null,refDescriptors:null,orbDetector:null,matcher:null}),M=Pe.useRef({frames:0,lockedFrames:0});Pe.useEffect(()=>{if(window.cv&&window.cv.Mat){o("ready");return}if(o("loading"),window.Module={onRuntimeInitialized:()=>{o("ready")}},!document.getElementById("opencv-script")){const R=document.createElement("script");R.id="opencv-script",R.src="https://docs.opencv.org/3.4.16/opencv.js",R.async=!0,document.body.appendChild(R)}},[]);const C=()=>{if(!window.cv||!p.current||!s.imageUrl)return!1;try{const R=window.cv,P=x.current;P.refGray&&P.refGray.delete(),P.refKeypoints&&P.refKeypoints.delete(),P.refDescriptors&&P.refDescriptors.delete(),P.orbDetector&&P.orbDetector.delete(),P.matcher&&P.matcher.delete();const V=document.createElement("canvas"),I=V.getContext("2d"),O=p.current,T=320;let N=O.naturalWidth||O.width,Y=O.naturalHeight||O.height;(N>T||Y>T)&&(N>Y?(Y=Math.round(Y*T/N),N=T):(N=Math.round(N*T/Y),Y=T)),V.width=N,V.height=Y,I.drawImage(O,0,0,N,Y);const H=R.imread(V),Q=new R.Mat;R.cvtColor(H,Q,R.COLOR_RGBA2GRAY);const re=new R.ORB,pe=new R.KeyPointVector,X=new R.Mat;re.detectAndCompute(Q,new R.Mat,pe,X);const oe=new R.BFMatcher(R.NORM_HAMMING,!0);return x.current={refGray:Q,refKeypoints:pe,refDescriptors:X,orbDetector:re,matcher:oe},H.delete(),!0}catch{return!1}},D=R=>{if(R.length<4)return!1;let P=[];for(let V=0;V<4;V++){let I=R[(V+1)%4].x-R[V].x,O=R[(V+1)%4].y-R[V].y,T=R[(V+2)%4].x-R[(V+1)%4].x,N=R[(V+2)%4].y-R[(V+1)%4].y;P.push(I*N-O*T>0)}return P.every(V=>V===P[0])},y=async()=>{if(!s.imageUrl){t("請先上傳辨識圖片！");return}if(r==="ready"){if(o("testing"),e("testing"),M.current={frames:0,lockedFrames:0},!C()){t("特徵提取失敗，請嘗試更換辨識圖片。"),o("ready");return}if(!navigator.mediaDevices||!navigator.mediaDevices.getUserMedia){t("⚠️ 無法啟動相機！請確認環境是否支援。"),o("ready");return}try{if(window.DeviceOrientationEvent&&typeof window.DeviceOrientationEvent.requestPermission=="function")try{await window.DeviceOrientationEvent.requestPermission()}catch(P){console.warn("Device orientation permission was not granted.",P)}const R=await navigator.mediaDevices.getUserMedia({video:{facingMode:"environment",width:{ideal:640}},audio:!1});v.current=R,f.current.srcObject=R,f.current.play(),f.current.onloadedmetadata=()=>{h.current.width=f.current.videoWidth,h.current.height=f.current.videoHeight,L()}}catch{t("無法存取相機。"),o("ready")}}},_=()=>{S.current&&(cancelAnimationFrame(S.current),S.current=null),v.current&&(v.current.getTracks().forEach(R=>R.stop()),v.current=null),f.current&&(f.current.srcObject=null),M.current.frames>30?M.current.lockedFrames/M.current.frames>.2?e("success"):e("unstable"):M.current.frames>0&&e("untested"),o("ready"),h.current&&h.current.getContext("2d").clearRect(0,0,h.current.width,h.current.height)};Pe.useEffect(()=>()=>{_();const R=x.current;R.refGray&&(R.refGray.delete(),R.refKeypoints.delete(),R.refDescriptors.delete(),R.orbDetector.delete(),R.matcher.delete())},[]);const L=()=>{const R=window.cv,P=x.current,V=f.current,I=h.current,O=I.getContext("2d");let T=performance.now(),N=null;const Y=.15;let H=0;const Q=3;let re=0;const pe=10;let X=null;const oe=()=>{if(!V||!V.srcObject||!P.refDescriptors)return;const J=performance.now(),ee=Math.round(1e3/(J-T));T=J,O.drawImage(V,0,0,I.width,I.height);let he=0,ce=0,B=!1,le=null,et=H%Q===0;if(H++,et){try{const Te=R.imread(I),ue=new R.Mat;R.cvtColor(Te,ue,R.COLOR_RGBA2GRAY);const be=new R.KeyPointVector,Se=new R.Mat;if(P.orbDetector.detectAndCompute(ue,new R.Mat,be,Se),!Se.empty()&&Se.rows>0){const Fe=new R.DMatchVector;P.matcher.match(P.refDescriptors,Se,Fe);let ot=[];for(let Et=0;Et<Fe.size();Et++)ot.push(Fe.get(Et));ot.sort((Et,St)=>Et.distance-St.distance);let gt=ot.filter(Et=>Et.distance<=50).slice(0,60);if(he=gt.length,gt.length>=12){const Et=[],St=[];for(let Nt=0;Nt<gt.length;Nt++){let Gt=gt[Nt];Et.push(P.refKeypoints.get(Gt.queryIdx).pt.x,P.refKeypoints.get(Gt.queryIdx).pt.y),St.push(be.get(Gt.trainIdx).pt.x,be.get(Gt.trainIdx).pt.y)}const Ot=R.matFromArray(Et.length/2,1,R.CV_32FC2,Et),Kt=R.matFromArray(St.length/2,1,R.CV_32FC2,St),Tt=new R.Mat,zt=R.findHomography(Ot,Kt,R.RANSAC,4,Tt);for(let Nt=0;Nt<Tt.rows;Nt++)Tt.data[Nt]===1&&ce++;if(!zt.empty()&&ce>=10&&ce/gt.length>=.35){const Nt=P.refGray.cols,Gt=P.refGray.rows,q=[0,0,1,Nt,0,1,Nt,Gt,1,0,Gt,1];let It=[];for(let wt=0;wt<4;wt++){let At=q[wt*3],qe=q[wt*3+1],Ht=zt.data64F[0]*At+zt.data64F[1]*qe+zt.data64F[2],U=zt.data64F[3]*At+zt.data64F[4]*qe+zt.data64F[5],E=zt.data64F[6]*At+zt.data64F[7]*qe+zt.data64F[8];It.push({x:Ht/E,y:U/E})}D(It)&&(le=It,B=!0)}Ot.delete(),Kt.delete(),Tt.delete(),zt.delete()}Fe.delete()}Te.delete(),ue.delete(),be.delete(),Se.delete()}catch{}B?(X=le,re=pe):re>0?re--:X=null}const st=X!==null;if(st){if(!N)N=JSON.parse(JSON.stringify(X));else for(let Te=0;Te<4;Te++)N[Te].x=N[Te].x*(1-Y)+X[Te].x*Y,N[Te].y=N[Te].y*(1-Y)+X[Te].y*Y;O.strokeStyle="#00ffcc",O.lineWidth=3,O.shadowBlur=10,O.shadowColor="#00ffcc",O.beginPath(),O.moveTo(N[0].x,N[0].y),O.lineTo(N[1].x,N[1].y),O.lineTo(N[2].x,N[2].y),O.lineTo(N[3].x,N[3].y),O.closePath(),O.stroke(),O.shadowBlur=0}else{N=null;const Te=Math.min(I.width,I.height)*.5,ue=(I.width-Te)/2,be=(I.height-Te)/2;O.strokeStyle="rgba(255, 70, 70, 0.5)",O.lineWidth=2,O.strokeRect(ue,be,Te,Te)}u(Te=>({fps:ee,matches:et?he:Te.matches,inliers:et?ce:Te.inliers,status:st?"LOCKED":"SEARCHING"})),M.current.frames++,st&&M.current.lockedFrames++,S.current=requestAnimationFrame(oe)};oe()};return g.jsxs("div",{className:"border border-slate-800 rounded-xl overflow-hidden bg-slate-950 shadow-md",children:[s.imageUrl&&g.jsx("img",{ref:p,src:s.imageUrl,alt:"ref",className:"hidden"}),g.jsxs("div",{className:"bg-slate-900/80 px-3 py-2 border-b border-slate-800 flex justify-between items-center",children:[g.jsx("h3",{className:"text-[10px] font-bold text-slate-300 tracking-wider",children:"AR ENGINE TESTER"}),g.jsx(bf,{status:s.recognitionStatus})]}),g.jsxs("div",{className:"p-3 space-y-3",children:[g.jsxs("div",{className:"relative bg-[#05070f] border border-slate-800 rounded-lg aspect-video w-full min-h-[160px] flex flex-col items-center justify-center font-mono text-[10px] text-cyan-500/70 overflow-hidden shadow-inner",children:[g.jsx("video",{ref:f,playsInline:!0,muted:!0,className:"hidden"}),g.jsx("canvas",{ref:h,className:`absolute inset-0 w-full h-full object-cover ${r!=="testing"&&"hidden"}`}),r==="testing"&&g.jsxs(g.Fragment,{children:[g.jsx("div",{className:"absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(16,24,48,0.1)_0%,rgba(10,13,20,0.7)_100%)] pointer-events-none z-10"}),g.jsx("div",{className:"absolute top-0 left-0 w-full h-[2px] bg-cyan-400/50 shadow-[0_0_10px_#00ffcc] animate-[scan_2s_linear_infinite] z-10"})]}),(r==="idle"||r==="ready"||r==="loading")&&g.jsx("div",{className:"text-center z-20",children:r==="loading"?g.jsxs("div",{className:"animate-pulse text-yellow-500",children:[g.jsx("span",{className:"animate-spin inline-block w-4 h-4 border-2 border-yellow-500 border-t-transparent rounded-full mr-2"}),"載入中..."]}):g.jsxs(g.Fragment,{children:[g.jsx(wf,{className:"w-8 h-8 mx-auto mb-2 opacity-30"}),g.jsx("p",{className:"text-xs",children:"READY"})]})}),r==="testing"&&g.jsxs("div",{className:"absolute top-2 left-3 z-20 flex flex-col space-y-1 text-[10px] text-slate-300 drop-shadow-md",children:[g.jsxs("span",{className:l.status==="LOCKED"?"text-cyan-400 font-bold":"text-red-400 font-bold",children:["STATE: ",l.status]}),g.jsxs("span",{children:["INLIERS: ",l.inliers]}),g.jsxs("span",{children:["FPS: ",l.fps]})]})]}),r==="testing"?g.jsx("button",{onClick:_,className:"w-full py-2 bg-red-500/10 hover:bg-red-500/20 text-red-400 border border-red-500/30 rounded-lg text-sm font-bold transition-colors",children:"停止測試"}):g.jsxs("button",{onClick:y,disabled:r==="loading"||!s.imageUrl,className:"w-full py-2 bg-slate-800 hover:bg-slate-700 disabled:opacity-50 border border-slate-700 rounded-lg text-sm font-bold text-slate-200 transition-colors flex items-center justify-center",children:[g.jsx(aw,{className:"w-4 h-4 mr-2 text-cyan-400"})," ",r==="loading"?"準備中...":"實測相機"]})]}),g.jsx("style",{dangerouslySetInnerHTML:{__html:"@keyframes scan { 0% { transform: translateY(0); opacity: 1; } 100% { transform: translateY(240px); opacity: 0; } }"}})]})}function F0({buildings:s,systemConfig:e,onMenuClick:t}){var lr,cr;const[r,o]=Pe.useState("idle"),[l,u]=Pe.useState(null),[f,h]=Pe.useState(null),[p,v]=Pe.useState([]),[S,x]=Pe.useState(!1),[M,C]=Pe.useState(0),[D,y]=Pe.useState("idle"),[_,L]=Pe.useState("checking"),[R,P]=Pe.useState("idle"),[V,I]=Pe.useState(0),[O,T]=Pe.useState(0),[N,Y]=Pe.useState({}),[H,Q]=Pe.useState(!1),[re,pe]=Pe.useState(""),X=Pe.useRef(null),oe=Pe.useRef(null),J=Pe.useRef(null),ee=Pe.useRef(null),he=Pe.useRef(null),ce=Pe.useRef(null),B=Pe.useRef(null),le=Pe.useRef(null),et=Pe.useRef(null),st=Pe.useRef(null),Te=Pe.useRef(!1),ue=Pe.useRef([]),be=Pe.useRef({matcher:null}),Se=Pe.useRef(null),Fe=Pe.useRef(null),ot=Pe.useRef(!1),gt=Pe.useRef({}),Et=Pe.useRef([]),St=Pe.useRef({nodes:{},edges:[]}),Ot=Pe.useRef(null),Kt=Pe.useRef("idle"),Tt=Pe.useRef({heading:null,pitch:0,roll:0}),zt=Pe.useRef(null),Nt=Af.useMemo(()=>{const j={},Le=[];return s.forEach(_e=>_e.floors.forEach(Ne=>{var G,se;const nt=Ne.bounds||{blX:0,blY:0,trX:100,trY:100},b=(Z,ne)=>({physX:nt.blX+Z*(nt.trX-nt.blX),physY:nt.trY-ne*(nt.trY-nt.blY)});Ne.markers.forEach(Z=>{Z.enabled&&(j[Z.id]={...Z,...b(Z.x,Z.y),isMarker:!0,bId:_e.id,fId:Ne.id,bName:_e.name,fName:Ne.name,bounds:nt})}),(G=Ne.waypoints)==null||G.forEach(Z=>{j[Z.id]={...Z,...b(Z.x,Z.y),isMarker:!1,bId:_e.id,fId:Ne.id,bName:_e.name,fName:Ne.name,bounds:nt}}),(se=Ne.edges)==null||se.forEach(Z=>{Le.push({...Z,fId:Ne.id})})})),{nodes:j,edges:Le}},[s]);Pe.useEffect(()=>{St.current=Nt},[Nt]),Pe.useEffect(()=>{Et.current=p},[p]),Pe.useEffect(()=>{T(0)},[l,p]),Pe.useEffect(()=>{if(!l||p.length<2){I(0);return}const j=performance.now(),Le=_e=>{I((_e-j)/5200%1),zt.current=requestAnimationFrame(Le)};return zt.current=requestAnimationFrame(Le),()=>{zt.current&&cancelAnimationFrame(zt.current)}},[l,p]),Pe.useEffect(()=>{Ot.current=null,Fe.current=null,Gt("idle")},[l]);const Gt=j=>{Kt.current!==j&&(Kt.current=j,y(j))},q=()=>new URLSearchParams(window.location.search).get("debugAR")==="1"||localStorage.getItem("debugAR")==="1",It=j=>{q()&&(gt.current={...gt.current,...j,isSecureContext:window.isSecureContext,lastUpdateTime:new Date().toLocaleTimeString()},Y(gt.current))};Pe.useEffect(()=>{let j=!0;return(async()=>{if(!navigator.xr||!window.isSecureContext){j&&L("unsupported");return}try{const _e=await navigator.xr.isSessionSupported("immersive-ar");j&&L(_e?"supported":"unsupported")}catch{j&&L("unsupported")}})(),()=>{j=!1}},[]);const wt=(j,Le)=>{const{nodes:_e,edges:Ne}=Nt,nt={};Object.keys(_e).forEach(De=>{nt[De]={}}),Ne.forEach(De=>{if(_e[De.start]&&_e[De.end]){const it=Math.hypot(_e[De.start].physX-_e[De.end].physX,_e[De.start].physY-_e[De.end].physY);nt[De.start][De.end]=it,nt[De.end][De.start]=it}});const b={};Object.values(_e).forEach(De=>{De.isVerticalShaft&&De.shaftId&&(b[De.shaftId]||(b[De.shaftId]=[]),b[De.shaftId].push(De.id))}),Object.values(b).forEach(De=>{for(let it=0;it<De.length;it++)for(let Je=it+1;Je<De.length;Je++)nt[De[it]][De[Je]]=5,nt[De[Je]][De[it]]=5});const G=De=>Object.keys(nt[De]).length>0,se=De=>{if(G(De))return De;const it=_e[De];let Je=1/0,bt=De;return Object.keys(_e).forEach(kt=>{if(_e[kt].fId===it.fId&&G(kt)){const w=Math.hypot(_e[kt].physX-it.physX,_e[kt].physY-it.physY);w<Je&&(Je=w,bt=kt)}}),bt},Z=se(j),ne=se(Le),Ie={},Xe={},Ee=new Set(Object.keys(_e));for(Object.keys(_e).forEach(De=>{Ie[De]=1/0,Xe[De]=null}),Ie[Z]=0;Ee.size>0;){let De=null;if(Ee.forEach(it=>{(De===null||Ie[it]<Ie[De])&&(De=it)}),Ie[De]===1/0||De===ne)break;Ee.delete(De),Object.entries(nt[De]).forEach(([it,Je])=>{if(Ee.has(it)){const bt=Ie[De]+Je;bt<Ie[it]&&(Ie[it]=bt,Xe[it]=De)}})}const Ze=[];let Qe=ne;for(;Qe;)Ze.unshift(Qe),Qe=Xe[Qe];return Ze.length===0||Ze[0]!==Z?[]:(Z!==j&&Ze.unshift(j),ne!==Le&&Ze.push(Le),Ze)};Pe.useEffect(()=>{v(f&&l&&f!==l?wt(f,l):[])},[f,l,Nt]),Pe.useEffect(()=>{if(!window.cv||!window.cv.Mat){if(o("loading"),window.Module={onRuntimeInitialized:()=>o("idle")},!document.getElementById("opencv-script")){const Ne=document.createElement("script");Ne.id="opencv-script",Ne.src="https://docs.opencv.org/3.4.16/opencv.js",Ne.async=!0,document.body.appendChild(Ne)}}else o("idle");let j=0;const Le=Ne=>{const nt=fw(Ne);It({alpha:Ne.alpha,beta:Ne.beta,gamma:Ne.gamma,webkitCompassHeading:Ne.webkitCompassHeading,currentHeading:nt}),nt!=null&&(Fe.current==null&&(Fe.current=nt),Tt.current={heading:nt,pitch:Ne.beta||0,roll:Ne.gamma||0},Se.current=nt,ot.current||(ot.current=!0,Q(!0)),It({baseHeading:Fe.current,relativeHeading:N0(nt,Fe.current),orientationEventActive:!0}))};window.DeviceOrientationEvent&&(window.addEventListener("deviceorientation",Le,!0),"ondeviceorientationabsolute"in window&&window.addEventListener("deviceorientationabsolute",Le,!0));const _e=setInterval(()=>{if(!ot.current)return;let Ne=Se.current;if(Ne==null)return;let nt=Ne-(j%360+360)%360;nt>180&&(nt-=360),nt<-180&&(nt+=360),j+=nt,C(j)},200);return()=>{E(),clearInterval(_e),window.removeEventListener("deviceorientation",Le,!0),"ondeviceorientationabsolute"in window&&window.removeEventListener("deviceorientationabsolute",Le,!0)}},[]);const At=async()=>{const j=window.cv;if(!j)return!1;ue.current=[],be.current.matcher=new j.BFMatcher(j.NORM_HAMMING,!0);const _e=Object.values(Nt.nodes).filter(Ne=>Ne.isMarker&&Ne.imageUrl).map(Ne=>new Promise(nt=>{const b=new Image;b.onload=()=>{try{const G=document.createElement("canvas"),se=G.getContext("2d");G.width=320,G.height=Math.round(320*(b.height/b.width)),se.drawImage(b,0,0,G.width,G.height);const Z=j.imread(G),ne=new j.Mat;j.cvtColor(Z,ne,j.COLOR_RGBA2GRAY);const Ie=new j.ORB,Xe=new j.KeyPointVector,Ee=new j.Mat;Ie.detectAndCompute(ne,new j.Mat,Xe,Ee),ue.current.push({markerId:Ne.id,gray:ne,kp:Xe,des:Ee,orb:Ie,width:ne.cols,height:ne.rows}),Z.delete(),nt(!0)}catch{nt(!1)}},b.onerror=()=>nt(!1),b.src=Ne.imageUrl}));return await Promise.all(_e),ue.current.length>0},qe=async()=>{const j={orientationPermission:"not-required",motionPermission:"not-required",granted:!0,reason:null};if(!window.isSecureContext&&location.hostname!=="localhost")return j.granted=!1,j.reason="AR 方向感測需要 HTTPS 或 localhost。",It(j),j;try{window.DeviceOrientationEvent&&typeof window.DeviceOrientationEvent.requestPermission=="function"&&(j.orientationPermission=await window.DeviceOrientationEvent.requestPermission(),j.orientationPermission!=="granted"&&(j.granted=!1)),window.DeviceMotionEvent&&typeof window.DeviceMotionEvent.requestPermission=="function"&&(j.motionPermission=await window.DeviceMotionEvent.requestPermission(),j.motionPermission!=="granted"&&(j.granted=!1))}catch(Le){j.granted=!1,j.reason=(Le==null?void 0:Le.message)||"方向感測授權失敗。"}return It(j),j},Ht=async()=>{const j=await qe();return j.granted?pe("已送出動作與方向啟用請求，請轉動手機確認羅盤資料是否開始變化。"):pe(j.reason||"瀏覽器未允許動作與方向存取，請在 Safari 設定中開啟「動作與方向存取」。"),j},U=async()=>{if(r!=="idle")return;if(o("loading"),!await At()){o("idle"),alert("無法提取特徵");return}try{await Ht();const Le=await navigator.mediaDevices.getUserMedia({video:{facingMode:"environment",width:{ideal:640}},audio:!1});J.current=Le,X.current.srcObject=Le,X.current.play(),X.current.onloadedmetadata=()=>{oe.current.width=X.current.videoWidth,oe.current.height=X.current.videoHeight,o("scanning"),Ye()}}catch{alert("無相機權限"),o("idle")}},E=()=>{ee.current&&cancelAnimationFrame(ee.current),J.current&&J.current.getTracks().forEach(j=>j.stop()),Ot.current=null,Fe.current=null,Gt("idle"),o("idle")},ae=(j,Le,_e=!1)=>{if(!Le||Le.length<2)return!1;const Ne=D0(Le);if(j.save(),j.beginPath(),Le.forEach((nt,b)=>{b===0?j.moveTo(nt.x,nt.y):j.lineTo(nt.x,nt.y)}),j.strokeStyle=_e?"rgba(255, 255, 255, 0.18)":"rgba(255, 255, 255, 0.24)",j.lineWidth=_e?8:10,j.lineCap="round",j.lineJoin="round",j.shadowBlur=_e?8:12,j.shadowColor="#ffffff",j.stroke(),Ne>8){const nt=_e?86:74,b=_e?26:30,G=Date.now()/18%nt;j.shadowBlur=_e?10:16,j.shadowColor="#ffffff",j.fillStyle="rgba(255,255,255,0.98)",j.strokeStyle="rgba(0,0,0,0.34)",j.lineWidth=2.5;for(let se=G;se<Ne;se+=nt){const Z=I0(Le,se);Z&&(j.save(),j.translate(Z.x,Z.y),j.rotate(Z.angle),j.beginPath(),j.moveTo(b*.55,0),j.lineTo(-b*.35,-b*.32),j.lineTo(-b*.15,0),j.lineTo(-b*.35,b*.32),j.closePath(),j.stroke(),j.fill(),j.restore())}}return j.restore(),!0},Me=(j,Le=[])=>{Le.forEach(_e=>{if(!_e||typeof _e.x!="number"||typeof _e.y!="number")return;const Ne=_e.type==="destination",nt=Ne?"#ef4444":"#a855f7",b=_e.label||(Ne?"目的地":"路段末端");j.save(),j.translate(_e.x,_e.y),j.shadowBlur=16,j.shadowColor=nt,j.fillStyle=nt,j.strokeStyle="#ffffff",j.lineWidth=3,j.beginPath(),j.arc(0,-18,Ne?15:13,0,Math.PI*2),j.fill(),j.stroke(),j.beginPath(),j.moveTo(-8,-6),j.lineTo(0,12),j.lineTo(8,-6),j.closePath(),j.fill(),j.stroke(),j.fillStyle="#ffffff",j.shadowBlur=0,j.font="bold 18px sans-serif",j.textAlign="center",j.textBaseline="middle",j.fillText(Ne?"!":"↑",0,-18),j.font="bold 13px sans-serif";const G=j.measureText(b).width+18;j.fillStyle="rgba(15, 23, 42, 0.86)",j.strokeStyle="rgba(255, 255, 255, 0.35)",j.lineWidth=1,j.beginPath(),j.roundRect(-G/2,20,G,26,13),j.fill(),j.stroke(),j.fillStyle="#ffffff",j.fillText(b,0,33),j.restore()})},Ae=(j,Le)=>{!Le||typeof Le.x!="number"||typeof Le.y!="number"||(j.save(),j.translate(Le.x,Le.y),j.shadowBlur=14,j.shadowColor="#22d3ee",j.strokeStyle="rgba(255,255,255,0.95)",j.fillStyle="rgba(34,211,238,0.95)",j.lineWidth=3,j.beginPath(),j.arc(0,0,10,0,Math.PI*2),j.fill(),j.stroke(),j.beginPath(),j.arc(0,0,20,0,Math.PI*2),j.strokeStyle="rgba(34,211,238,0.55)",j.stroke(),j.restore())},Ve=j=>{const Le=Ot.current;if(!Le||!Le.points||Le.points.length<2)return!1;const _e=Tt.current,Ne=ot.current&&_e.heading!=null&&Le.orientation.heading!=null,nt=Ne?R0(_e.heading,Le.orientation.heading):0,b=Ne?_e.pitch-Le.orientation.pitch:0,G=Ne?_e.roll-Le.orientation.roll:0,se=(G-nt)*Math.PI/180,Z=Math.cos(se),ne=Math.sin(se),Ie=Le.anchor||Le.points[0],Xe=j.canvas.width/2,Ee=j.canvas.height/2,Ze=Ie.x*j.canvas.width,Qe=Ie.y*j.canvas.height,De=Math.max(j.canvas.width,j.canvas.height)*.95,it=j.canvas.width*1.8,Je=j.canvas.height*1.2,bt=Math.max(-it,Math.min(it,Math.tan(nt*Math.PI/180)*De)),kt=Math.max(-Je,Math.min(Je,Math.tan(b*Math.PI/180)*De*.75)),k=((at,ut)=>{const mt=at-Xe,rt=ut-Ee;return{x:Xe+mt*Z-rt*ne-bt,y:Ee+mt*ne+rt*Z+kt}})(Ze,Qe),F=at=>{const ut=at.x*j.canvas.width,mt=at.y*j.canvas.height,rt=ut-Ze,Yt=mt-Qe;return{x:k.x+rt*Z-Yt*ne,y:k.y+rt*ne+Yt*Z}},W=Le.points.map(F),Re=(Le.pins||[]).map(F).map((at,ut)=>{var mt,rt;return{...at,type:(mt=Le.pins[ut])==null?void 0:mt.type,label:(rt=Le.pins[ut])==null?void 0:rt.label}}),ve=N0(_e.heading,Le.baseHeading),Ue=Le.targetBearing!=null&&ve!=null?R0(Le.targetBearing,ve):null;It({currentHeading:_e.heading,baseHeading:Le.baseHeading,relativeHeading:ve,targetBearing:Le.targetBearing,headingDelta:nt,arrowRotation:Ue,finalArrowRotation:Ue==null?null:Ue+G,currentARMode:"camera-overlay"});const ft=ae(j,W,!0);return ft&&(Ae(j,k),Me(j,Re)),ft},We=()=>{if(Et.current.length>1)return Et.current;const j=Object.values(St.current.nodes).filter(_e=>_e.isMarker&&_e.id!==l).map(_e=>_e.id),Le=f||j[0];return!Le||!l||Le===l?[]:wt(Le,l)},xe=()=>{const j=We(),Le=St.current.nodes,_e=j.map(Ee=>Le[Ee]).filter(Boolean);if(_e.length<2)return null;const Ne=_e[0],nt=.08,b=_e.map(Ee=>new ie((Ee.physX-Ne.physX)*nt,.03,-(Ee.physY-Ne.physY)*nt)),G=new Ts,se=P0(b,.045,16777215,.18),Z=P0(b,.016,16777215,.36);se&&G.add(se),Z&&G.add(Z);const ne=xw(b);ne&&G.add(ne);const Ie=new Qn(new ac(.1,24,24),new ts({color:2282478}));Ie.position.copy(b[0]),Ie.position.y+=.08,G.add(Ie);const Xe=new Qn(new ac(.12,24,24),new ts({color:16731471}));return Xe.position.copy(b[b.length-1]),Xe.position.y+=.1,G.add(Xe),G},we=async()=>{const j=ce.current;if(j)try{await j.end()}catch{}else Ce()},Ce=()=>{le.current&&le.current.traverse(j=>{j.geometry&&j.geometry.dispose(),j.material&&j.material.dispose()}),B.current&&(B.current.setAnimationLoop(null),B.current.dispose(),B.current.domElement.remove()),ce.current=null,B.current=null,le.current=null,et.current=null,st.current=null,Te.current=!1,P("idle")},tt=async()=>{var j;if(!(_!=="supported"||!navigator.xr||ce.current)){P("starting"),E();try{const Le={requiredFeatures:["hit-test"],optionalFeatures:he.current?["local-floor","dom-overlay","anchors"]:["local-floor","anchors"]};he.current&&(Le.domOverlay={root:he.current});const _e=await navigator.xr.requestSession("immersive-ar",Le),Ne=new XE({alpha:!0,antialias:!0});Ne.xr.enabled=!0,Ne.setPixelRatio(window.devicePixelRatio||1),Ne.setSize(window.innerWidth,window.innerHeight),Ne.domElement.className="absolute inset-0 h-full w-full",(j=he.current)==null||j.appendChild(Ne.domElement),await Ne.xr.setSession(_e);const nt=new m_,b=new Ni,G=new Qn(new Hf(.18,.22,32).rotateX(-Math.PI/2),new ts({color:65484,transparent:!0,opacity:.85}));G.matrixAutoUpdate=!1,G.visible=!1,nt.add(G);const se=await _e.requestReferenceSpace("local-floor").catch(()=>_e.requestReferenceSpace("local")),Z=await _e.requestReferenceSpace("viewer"),ne=await _e.requestHitTestSource({space:Z});ce.current=_e,B.current=Ne,et.current=ne,st.current=se,P("placing");const Ie=Xe=>{if(Te.current)return;const Ee=xe();if(!Ee){P("no-route");return}Ee.matrix.fromArray(Xe),Ee.matrix.decompose(Ee.position,Ee.quaternion,Ee.scale),nt.add(Ee),le.current=Ee,Te.current=!0,P("anchored")};_e.addEventListener("select",()=>{G.visible&&Ie(G.matrix.elements)}),_e.addEventListener("end",Ce),Ne.setAnimationLoop((Xe,Ee)=>{if(le.current&&le.current.traverse(Ze=>vw(Ze,Xe)),Ee&&!Te.current){const Ze=Ee.getHitTestResults(ne);if(Ze.length){const Qe=Ze[0].getPose(se);Qe&&(G.visible=!0,G.matrix.fromArray(Qe.transform.matrix))}else G.visible=!1}else G.visible=!1;Ne.render(nt,b)})}catch(Le){console.warn("Unable to start WebXR AR mode.",Le),Ce(),P("failed")}}},Ye=()=>{const j=window.cv,Le=X.current,_e=oe.current,Ne=_e.getContext("2d"),nt=be.current.matcher;let b=0,G=null,se=null,Z=0,ne=0;const Ie=()=>{if(!Le||!Le.srcObject)return;Ne.drawImage(Le,0,0,_e.width,_e.height);let Xe=!1;if(b%4===0){try{const Qe=j.imread(_e),De=new j.Mat;j.cvtColor(Qe,De,j.COLOR_RGBA2GRAY);const it=new j.KeyPointVector,Je=new j.Mat;if(ue.current[0].orb.detectAndCompute(De,new j.Mat,it,Je),!Je.empty())for(let bt of ue.current){const kt=new j.DMatchVector;nt.match(bt.des,Je,kt);let w=[];for(let F=0;F<kt.size();F++)w.push(kt.get(F));w.sort((F,W)=>F.distance-W.distance);const k=w.filter(F=>F.distance<=50).slice(0,60);if(k.length>=12){const F=[],W=[];for(let ut of k)F.push(bt.kp.get(ut.queryIdx).pt.x,bt.kp.get(ut.queryIdx).pt.y),W.push(it.get(ut.trainIdx).pt.x,it.get(ut.trainIdx).pt.y);const Re=j.matFromArray(F.length/2,1,j.CV_32FC2,F),ve=j.matFromArray(W.length/2,1,j.CV_32FC2,W),Ue=new j.Mat,ft=j.findHomography(Re,ve,j.RANSAC,4,Ue);let at=0;for(let ut=0;ut<Ue.rows;ut++)Ue.data[ut]===1&&at++;!ft.empty()&&at>=10&&(G&&G.delete(),G=ft.clone(),se=bt.markerId,h(se),Xe=!0),Re.delete(),ve.delete(),Ue.delete(),ft.delete()}if(kt.delete(),Xe)break}Qe.delete(),De.delete(),it.delete(),Je.delete()}catch{}Xe?(ne=8,Z=Date.now()):ne>0?ne--:(G&&(G.delete(),G=null),se=null)}b++,!Z&&!Ot.current&&(G&&(G.delete(),G=null),se=null);const Ee=St.current,Ze=Et.current;if(G&&se&&Ze.length>1){const Qe=Ee.nodes[se],De=ue.current.find(it=>it.markerId===se);if(Qe&&De){const it=De.width/.3,Je=[],bt=[],kt=Ze.indexOf(se),w=kt>=0?kt:0,k=hw(Ee.nodes[Ze[w]],Ee.nodes[Ze[w+1]]);for(let F=0;F<Ze.length;F++){const W=Ze[F],Re=Ee.nodes[W];if(!Re||Re.fId!==Qe.fId)break;const ve=Re.physX-Qe.physX,Ue=-(Re.physY-Qe.physY),ft=De.width/2+ve*it,at=De.height/2+Ue*it,ut=G.data64F,mt=ut[6]*ft+ut[7]*at+ut[8];if(mt>0){const rt=(ut[0]*ft+ut[1]*at+ut[2])/mt,Yt=(ut[3]*ft+ut[4]*at+ut[5])/mt;Je.push({x:rt,y:Yt}),bt.push({x:rt,y:Yt,nodeId:W})}}if(Je.length>=2){const F=Ot.current,W=Je.map(rt=>({x:rt.x/_e.width,y:rt.y/_e.height})),Re=W[0],ve=bt[bt.length-1],Ue=bt.find(rt=>rt.nodeId===l),ft=[];ve&&ft.push({x:ve.x,y:ve.y,type:Ue?"destination":"endpoint",label:Ue?"目的地":"路段末端"}),Ue&&Ue!==ve&&ft.push({x:Ue.x,y:Ue.y,type:"destination",label:"目的地"}),Fe.current==null&&Tt.current.heading!=null&&(Fe.current=Tt.current.heading);const at=U0(F==null?void 0:F.points,W,F?.45:1);at.length>0&&(at[0]=Re);const ut=ft.map(rt=>({x:rt.x/_e.width,y:rt.y/_e.height,type:rt.type,label:rt.label})),mt={markerId:se,orientation:{...Tt.current},baseHeading:Fe.current,targetBearing:k,updatedAt:Date.now(),anchor:Re,points:at,pins:U0(F==null?void 0:F.pins,ut,F?.45:1)};Ot.current={...mt},Ve(Ne),It({arrowElementFound:!0,targetBearing:k,baseHeading:Fe.current,currentARMode:"camera-overlay"}),Gt("locked")}}}else{const Qe=Ze.length>1&&Ve(Ne);if(Gt(Qe?"holding":"searching"),!Qe){const De=Math.min(_e.width,_e.height)*.6;Ne.strokeStyle="rgba(0, 255, 204, 0.4)",Ne.lineWidth=2,Ne.strokeRect((_e.width-De)/2,(_e.height-De)/2,De,De)}}ee.current=requestAnimationFrame(Ie)};Ie()};if(!l){const j=Object.values(Nt.nodes).filter(Le=>Le.isMarker).reduce((Le,_e)=>{const Ne=`${_e.bName} - ${_e.fName}`;return Le[Ne]||(Le[Ne]=[]),Le[Ne].push(_e),Le},{});return g.jsxs("div",{className:"flex-1 flex flex-col relative overflow-hidden bg-slate-950",children:[g.jsx("div",{className:"absolute top-4 left-4 z-40 md:hidden",children:g.jsx("button",{onClick:t,className:"bg-slate-800 text-slate-300 p-2.5 rounded-lg border border-slate-700 hover:text-white shadow-lg transition-colors",children:g.jsx(co,{className:"w-5 h-5"})})}),g.jsxs("div",{className:"flex-1 overflow-y-auto p-6 pt-20",children:[g.jsxs("h2",{className:"text-2xl font-bold text-white mb-6 flex items-center md:mt-0 mt-2",children:[g.jsx(lo,{className:"mr-3 text-cyan-400"})," 請選擇目的地"]}),Object.keys(j).length===0?g.jsxs("div",{className:"flex flex-col items-center justify-center py-20 text-center border border-dashed border-slate-800 rounded-2xl bg-slate-900/50 mt-10",children:[g.jsx(ha,{className:"w-16 h-16 text-slate-700 mb-4"}),g.jsx("h3",{className:"text-lg font-bold text-slate-400 mb-2",children:"目前尚無可用目的地"}),g.jsxs("p",{className:"text-sm text-slate-500 max-w-sm",children:["系統中尚未建立任何啟用中的 AR 點位。",g.jsx("br",{}),"請點擊左上角選單，切換至「平面圖管理」進行新增。"]})]}):Object.entries(j).map(([Le,_e])=>g.jsxs("div",{className:"mb-6",children:[g.jsx("h3",{className:"text-slate-400 font-bold mb-3",children:Le}),g.jsx("div",{className:"grid grid-cols-1 sm:grid-cols-2 gap-3",children:_e.map(Ne=>g.jsxs("button",{onClick:()=>u(Ne.id),className:"p-4 bg-slate-900 border border-slate-800 rounded-xl flex text-left hover:border-cyan-500 hover:bg-slate-800 transition-colors group",children:[g.jsx("span",{className:"font-mono text-cyan-400 font-bold mr-3 group-hover:scale-110 transition-transform",children:Ne.code}),g.jsx("div",{className:"flex-1",children:g.jsx("div",{className:"text-white font-bold",children:Ne.title})})]},Ne.id))})]},Le))]})]})}const Oe=Nt.nodes[l],Ke=f?Nt.nodes[f]:null,He=p.length>1?p[1]:null;He&&Nt.nodes[He];const Pt=j=>{if(!j)return"";if(j.fName)return j.fName;for(const Le of s){const _e=Le.floors.find(Ne=>Ne.id===j.fId);if(_e!=null&&_e.name)return _e.name}return j.fId||""},$=p.map(j=>Nt.nodes[j]).filter(Boolean),Ge=mw($),me=[];$.forEach(j=>{const Le=me[me.length-1];!Le||Le.floorId!==j.fId?me.push({floorId:j.fId,floorName:Pt(j),nodes:[j]}):Le.nodes.push(j)});const lt=Ke||Oe?{floorId:(Ke||Oe).fId,floorName:Pt(Ke||Oe),nodes:[Ke||Oe]}:null,ke=me.length?Math.min(O,me.length-1):0,ye=me[ke]||lt,ct=me[ke-1]||null,Mt=me[ke+1]||null,Xt=(lr=ye==null?void 0:ye.nodes)==null?void 0:lr[ye.nodes.length-1];(cr=ye==null?void 0:ye.nodes)==null||cr[0];const $t=Mt?Gn(Mt.floorName)-Gn(ye.floorName):0,En=$t>0?"上樓":$t<0?"下樓":"前往",In=ct?Gn(ye.floorName)-Gn(ct.floorName):0,li=In>0?"上樓":In<0?"下樓":"前往",_i=f===l?"已抵達目的地":Mt?`請依照 ${ye.floorName} 平面圖前往轉乘點，接著${En}至 ${Mt.floorName}`:ye?`請依照 ${ye.floorName} 平面圖前往目的地`:"請先掃描導引圖以建立路徑",Ii=!!(Mt||ct);let Fn=ye?ye.floorId:Ke?Ke.fId:Oe.fId,Wn=null,Di=ye?ye.floorName:Ke?Ke.fName:Oe.fName,Xn={blX:0,blY:0,trX:100,trY:100};s.forEach(j=>j.floors.forEach(Le=>{Le.id===Fn&&(Wn=Le.imageUrl,Xn=Jr(Le),Di=Le.name)}));const gn=(j,Le)=>{const _e=Xn.trX-Xn.blX,Ne=Xn.trY-Xn.blY,nt=_e!==0?(j-Xn.blX)/_e*100:50,b=Ne!==0?(Xn.trY-Le)/Ne*100:50;return{x:nt,y:b}},Yn=(ye==null?void 0:ye.nodes)||[],ci=Yn.filter(j=>j&&j.fId===Fn).map(j=>gn(j.physX,j.physY)),Li=D0(ci),yi=Ke&&Ke.fId===Fn?Ke:ci.length?null:Oe,ui=Li>0?I0(ci,V*Li):yi?gn(yi.physX,yi.physY):null;return g.jsxs("div",{className:"flex-1 bg-black flex flex-col relative overflow-hidden",children:[g.jsx("div",{className:"absolute top-4 left-4 z-40",children:g.jsx("button",{onClick:()=>{E(),u(null),h(null)},className:"bg-white/20 text-white px-4 py-2 rounded-full backdrop-blur-md hover:bg-white/30 transition-colors",children:"重新選擇目的地"})}),g.jsxs("div",{className:"flex-1 relative flex items-center justify-center",children:[g.jsx("div",{ref:he,className:`absolute inset-0 z-10 ${R==="idle"?"pointer-events-none":""}`}),g.jsx("video",{ref:X,playsInline:!0,muted:!0,className:"hidden"}),g.jsx("canvas",{ref:oe,className:`absolute inset-0 w-full h-full object-cover ${r!=="scanning"&&"hidden"}`}),r==="scanning"&&g.jsxs("div",{className:"absolute top-4 right-4 z-40 rounded-full border border-cyan-400/30 bg-slate-950/75 px-3 py-2 text-xs font-bold text-cyan-100 shadow-lg backdrop-blur-md",children:[D==="locked"&&"AR 路徑已鎖定",D==="holding"&&"陀螺儀空間錨點",D==="searching"&&"請重新對準導引圖",D==="idle"&&"準備定位"]}),r==="scanning"&&!H&&g.jsxs("div",{className:"absolute left-4 right-4 top-16 z-40 rounded-2xl border border-yellow-400/40 bg-slate-950/88 p-4 text-sm leading-relaxed text-yellow-50 shadow-xl backdrop-blur-md md:left-auto md:max-w-sm",children:[g.jsx("div",{className:"mb-1 font-bold text-yellow-200",children:"需要開啟動作與方向"}),g.jsx("div",{className:"mb-3 text-xs text-yellow-100/85",children:"若沒有啟用，AR 箭頭無法隨手機轉向套疊在實景中。"}),re&&g.jsx("div",{className:"mt-2 text-xs text-yellow-100/90",children:re})]}),r==="scanning"&&q()&&g.jsxs("div",{className:"absolute right-4 top-16 z-40 max-w-[260px] rounded-xl border border-slate-600 bg-slate-950/85 p-3 text-[10px] leading-relaxed text-slate-200 shadow-xl backdrop-blur-md",children:[g.jsx("div",{className:"mb-1 font-bold text-cyan-300",children:"AR Debug"}),[["secure",String(N.isSecureContext)],["permission",`${N.orientationPermission||"-"} / ${N.motionPermission||"-"}`],["alpha",N.alpha==null?"-":Math.round(N.alpha)],["webkit",N.webkitCompassHeading==null?"-":Math.round(N.webkitCompassHeading)],["heading",N.currentHeading==null?"-":Math.round(N.currentHeading)],["base",N.baseHeading==null?"-":Math.round(N.baseHeading)],["relative",N.relativeHeading==null?"-":Math.round(N.relativeHeading)],["target",N.targetBearing==null?"-":Math.round(N.targetBearing)],["rotate",N.arrowRotation==null?"-":Math.round(N.arrowRotation)],["mode",N.currentARMode||"-"],["updated",N.lastUpdateTime||"-"]].map(([j,Le])=>g.jsxs("div",{className:"flex justify-between gap-3 border-t border-white/5 py-0.5",children:[g.jsx("span",{className:"text-slate-400",children:j}),g.jsx("span",{className:"font-mono text-white",children:Le})]},j))]}),r==="scanning"&&Wn&&g.jsxs("div",{onClick:()=>x(!S),className:`absolute transition-all duration-300 z-30 bg-slate-900/80 backdrop-blur-md border border-slate-700 shadow-2xl flex items-center justify-center overflow-hidden cursor-pointer ${S?"top-16 left-4 right-4 bottom-32 rounded-2xl":"top-20 right-4 w-32 h-32 md:w-48 md:h-48 rounded-xl"}`,children:[g.jsxs("div",{className:"relative w-full h-full",children:[g.jsx("img",{src:Wn,className:"absolute inset-0 w-full h-full opacity-50",style:{objectFit:"fill"}}),g.jsx("div",{className:"absolute left-2 top-2 z-30 rounded-full border border-white/25 bg-black/75 px-3 py-1.5 text-xs font-bold text-white shadow-lg backdrop-blur-sm",children:Ii?`自動切換至 ${Di}`:`目前平面圖 ${Di}`}),g.jsxs("svg",{className:"absolute inset-0 w-full h-full pointer-events-none",style:{overflow:"visible"},children:[g.jsx("defs",{children:g.jsx("marker",{id:"minimap-arrow",markerWidth:"6",markerHeight:"4",refX:"5",refY:"2",orient:"auto",children:g.jsx("polygon",{points:"0 0, 6 2, 0 4",fill:"#00ffcc"})})}),Yn.map((j,Le)=>{if(Le===Yn.length-1)return null;const _e=Yn[Le+1];if(j.fId===Fn&&_e.fId===Fn){const Ne=gn(j.physX,j.physY),nt=gn(_e.physX,_e.physY);return g.jsx("line",{x1:`${Ne.x}%`,y1:`${Ne.y}%`,x2:`${nt.x}%`,y2:`${nt.y}%`,stroke:"#00ffcc",strokeWidth:"2",strokeDasharray:"6 4",markerEnd:"url(#minimap-arrow)",className:"animate-[dash_1s_linear_infinite]"},Le)}return null})]}),ui&&g.jsx("div",{className:"absolute z-30 pointer-events-none",style:{left:`${ui.x}%`,top:`${ui.y}%`,transform:`translate3d(-50%, -82%, 0) rotate(${ui.angle||0}rad)`,willChange:"transform"},children:g.jsxs("div",{className:"relative flex h-12 w-12 md:h-16 md:w-16 items-center justify-center",children:[g.jsx("div",{className:"absolute inset-1 rounded-full bg-white/35 blur-md"}),g.jsx("img",{src:"assets/ar/mascot-walking-small.png",alt:"導引吉祥物",className:"relative h-full w-full rounded-full border-2 border-white/80 bg-white object-cover shadow-[0_0_16px_rgba(255,255,255,0.9)]",style:{transform:`rotate(${-(ui.angle||0)}rad)`,backfaceVisibility:"hidden",willChange:"transform"}})]})}),Mt&&Xt&&Xt.fId===Fn&&g.jsx("div",{className:"absolute z-30 pointer-events-none",style:{left:`${gn(Xt.physX,Xt.physY).x}%`,top:`${gn(Xt.physX,Xt.physY).y}%`,transform:"translate(-50%, -140%)"},children:g.jsx("div",{className:"flex h-12 w-12 items-center justify-center rounded-full border-2 border-white bg-purple-600 text-white shadow-[0_0_18px_rgba(168,85,247,0.85)]",children:$t>=0?g.jsx(Tg,{className:"h-8 w-8 stroke-[3.5]"}):g.jsx(Eg,{className:"h-8 w-8 stroke-[3.5]"})})}),!1,Oe&&Oe.fId===Fn&&g.jsx("div",{className:"absolute z-20 pointer-events-none",style:{left:`${gn(Oe.physX,Oe.physY).x}%`,top:`${gn(Oe.physX,Oe.physY).y}%`,transform:"translate(-50%, -50%)"},children:g.jsxs("div",{className:"relative w-6 h-6 flex items-center justify-center",children:[g.jsx("div",{className:"absolute w-full h-full border-2 border-red-500 rounded-full animate-ping opacity-75"}),g.jsx("div",{className:"w-2.5 h-2.5 bg-red-500 rounded-full z-10"})]})})]}),g.jsx("div",{className:"absolute bottom-1.5 right-1.5 bg-black/60 p-1.5 rounded-lg text-white pointer-events-none",children:S?g.jsx(Rg,{className:"w-4 h-4"}):g.jsx(Cg,{className:"w-4 h-4"})}),g.jsxs("div",{className:"absolute bottom-0 left-0 w-full text-center bg-black/70 text-[10px] text-white py-1 backdrop-blur-sm pointer-events-none",children:[S?"縮小":"放大"," - ",Ke?Ke.fName:Oe.fName," ",H?`(${Math.round((M%360+360)%360)}°)`:"(等待羅盤訊號...)"]})]}),r!=="scanning"&&R==="idle"&&g.jsxs("div",{className:"z-20 w-full max-w-md px-6 text-center",children:[g.jsx(cw,{className:"w-20 h-20 text-cyan-500/50 mb-6 mx-auto"}),g.jsx("h2",{className:"text-2xl font-bold text-white mb-3",children:"開啟 AR 導引"}),g.jsx("p",{className:"mb-6 text-sm leading-relaxed text-slate-300",children:"真 AR 模式會把路徑建立成 3D 物件並鎖定在空間；不支援 WebXR 的裝置可使用相機疊圖備援。"}),g.jsxs("div",{className:"space-y-3",children:[!H&&g.jsxs("div",{className:"rounded-2xl border border-yellow-400/35 bg-yellow-400/10 p-4 text-left text-sm leading-relaxed text-yellow-50",children:[g.jsx("div",{className:"mb-2 font-bold text-yellow-200",children:"請開啟「動作與方向」權限"}),g.jsx("div",{className:"mb-3 text-xs text-yellow-100/85",children:"AR 箭頭需要手機羅盤資料才能隨轉向正確套疊。iPhone 請用 Safari 開啟，並允許動作與方向存取。"}),re&&g.jsx("div",{className:"mt-3 text-xs text-yellow-100/90",children:re})]}),g.jsx("button",{onClick:tt,disabled:_!=="supported",className:"w-full rounded-full bg-cyan-500 px-8 py-4 text-lg font-bold text-slate-950 shadow-[0_0_20px_rgba(6,182,212,0.4)] transition-colors hover:bg-cyan-400 disabled:cursor-not-allowed disabled:opacity-45",children:_==="checking"?"檢查真 AR 支援中...":_==="supported"?"開啟真 AR 空間模式":"此裝置不支援真 AR 模式"}),g.jsx("button",{onClick:U,disabled:r==="loading",className:"w-full rounded-full border border-slate-600 bg-slate-900/80 px-8 py-3 text-sm font-bold text-slate-100 transition-colors hover:bg-slate-800 disabled:opacity-50",children:r==="loading"?"系統準備中...":"開啟動作與方向及相機"})]}),_==="unsupported"&&g.jsx("div",{className:"mt-4 rounded-xl border border-yellow-500/30 bg-yellow-500/10 p-3 text-left text-xs leading-relaxed text-yellow-100",children:"iPhone Safari 或未支援 WebXR 的瀏覽器無法做真正空間錨定，只能使用備援模式。Android Chrome 支援時會優先使用真 AR。"})]}),!1]}),R!=="idle"&&g.jsxs("div",{className:"absolute inset-x-4 bottom-6 z-40 rounded-2xl border border-cyan-400/30 bg-slate-950/80 p-4 text-center text-sm text-cyan-50 shadow-2xl backdrop-blur-md",children:[R==="starting"&&"正在啟動真 AR 空間模式...",R==="placing"&&"請對準地面，點一下畫面放置 AR 路徑。",R==="anchored"&&"AR 路徑已鎖定在空間中。",R==="no-route"&&"目前找不到可用路徑，請先確認後台路網與目的地。",R==="failed"&&"真 AR 啟動失敗，請改用相機疊圖備援。",g.jsx("button",{onClick:we,className:"mt-3 rounded-full border border-slate-500 px-4 py-2 text-xs font-bold text-slate-100",children:"關閉真 AR"})]}),g.jsx("div",{className:`absolute bottom-0 left-0 w-full p-4 z-40 transition-transform duration-500 ease-out flex justify-center ${Ke?"translate-y-0":"translate-y-full"}`,children:g.jsxs("div",{className:"bg-slate-900/95 backdrop-blur-xl border border-slate-700 w-full max-w-md rounded-2xl p-6 shadow-2xl relative overflow-hidden",children:[g.jsx("div",{className:"absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-cyan-400 to-blue-500"}),g.jsxs("div",{className:"grid grid-cols-[44px_1fr_44px] items-stretch gap-3",children:[g.jsx("button",{onClick:()=>T(j=>Math.max(0,j-1)),disabled:!ct,className:"flex h-full min-h-20 items-center justify-center rounded-xl border border-slate-700 bg-slate-800/80 text-slate-200 transition-colors hover:bg-slate-700 disabled:cursor-not-allowed disabled:opacity-25",title:"上一張平面圖",children:g.jsx(wg,{className:"h-5 w-5"})}),g.jsxs("div",{className:"min-w-0 rounded-xl border border-slate-700 bg-slate-800/80 p-4 shadow-inner",children:[g.jsxs("div",{className:"mb-1 flex items-center justify-between gap-2 text-xs font-bold text-slate-400",children:[g.jsxs("span",{children:[(ye==null?void 0:ye.floorName)||Pt(Ke||Oe)," ","平面圖"]}),me.length>1&&g.jsxs("span",{children:[ke+1," / ",me.length]})]}),g.jsx("div",{className:`text-sm font-bold leading-relaxed ${f===l?"text-green-400":Mt?"text-purple-300":"text-yellow-300"}`,children:_i}),Ge>0&&g.jsxs("div",{className:"mt-2 inline-flex rounded-full border border-cyan-400/25 bg-cyan-400/10 px-3 py-1 text-[11px] font-bold text-cyan-100",children:["預估路徑長度：",Ge<100?Ge.toFixed(1):Math.round(Ge)," m"]}),ct&&g.jsxs("div",{className:"mt-2 text-[11px] text-slate-500",children:["上一張：",ct.floorName,"；本張是",li,"後的導引段。"]})]}),g.jsx("button",{onClick:()=>T(j=>Math.min(me.length-1,j+1)),disabled:!Mt,className:"flex h-full min-h-20 items-center justify-center rounded-xl border border-purple-500/40 bg-purple-500/20 text-purple-200 transition-colors hover:bg-purple-500/30 disabled:cursor-not-allowed disabled:border-slate-700 disabled:bg-slate-800/80 disabled:text-slate-500 disabled:opacity-35",title:"下一張平面圖",children:g.jsx(bg,{className:"h-5 w-5"})})]})]})}),g.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @keyframes scan { 0% { transform: translateY(-300px); opacity: 1; } 100% { transform: translateY(300px); opacity: 0; } }
        @keyframes dash { to { stroke-dashoffset: -20; } }
      `}})]})}const lc=document.getElementById("ar-root");if(!lc)throw new Error("Missing #ar-root element.");const Ng=new URLSearchParams(window.location.search),Mw=window.location.pathname.endsWith("/admin-ar.html"),Pg=lc.dataset.embedded==="true"||Ng.get("embedded")==="1",O0=Mw||Pg;vv.createRoot(lc).render(g.jsx(Af.StrictMode,{children:g.jsx(yw,{embedded:Pg,initialTab:O0?lc.dataset.initialTab||Ng.get("tab")||"map":"frontend",publicOnly:!O0})}));
